...
mod_ricker_2 = cmdstan_model(stan_file = 'code/fit/Ricker_random_time_a_posi.stan')
mod_ricker = cmdstan_model(stan_file = 'code/fit/Ricker_random_time.stan')
numer_cores = 4
options(mc.cores = numer_cores)

# Fit
load('code/data preparation/transformed data/fit_stage_fp_alltime_same_0.15.RData')
load('code/data preparation/transformed data/fit_stage_fp_alltime_same_0.20.RData')
load('code/data preparation/transformed data/fit_stage_fp_alltime_same_0.25.RData')
load('code/data preparation/transformed data/fit_stage_fp_alltime_same_0.3.RData')
for (z in 1:length(fit_stage_fp_alltime_same_0.15)) {
  z = 1
  datalist = fit_stage_fp_alltime_same_0.25[[z]][[5]]
  growD = fit_stage_fp_alltime_same_0.25[[z]][[4]]
  sp = colnames(growD)[10:ncol(growD)]
  posterior_l = list()
  summary_l = list()
  for (j in 1:length(datalist)) {
    j = 1
    RickerFit_0.15 = mod_ricker_2$sample(data = fit_stage_fp_alltime_same_0.15[[z]][[5]][[j]], 
                                         seed = 123, 
                                         chains = 4, 
                                         parallel_chains = 4,
                                         iter_warmup = 1000,
                                         ...
                                         #init = inits,
                                         adapt_delta = 0.99)
    loo_result_0.15 = RickerFit_0.15$loo(cores = numer_cores)
    
    RickerFit_0.20 = mod_ricker_2$sample(data = fit_stage_fp_alltime_same_0.20[[z]][[5]][[j]],
                                         seed = 123, 
                                         chains = 4, 
                                         parallel_chains = 4,
                                         iter_warmup = 1000,
                                         ...
                                         #init = inits,
                                         adapt_delta = 0.99)
    loo_result_0.20 = RickerFit_0.20$loo(cores = numer_cores)
    
    RickerFit_0.25 = mod_ricker_2$sample(data = fit_stage_fp_alltime_same_0.25[[z]][[5]][[j]],
                                         seed = 123, 
                                         chains = 4, 
                                         parallel_chains = 4,
                                         iter_warmup = 1000,
                                         ...
                                         #init = inits,
                                         adapt_delta = 0.99)
    loo_result_0.25 = RickerFit_0.25$loo(cores = numer_cores)
    
    RickerFit_0.3 = mod_ricker_2$sample(data = fit_stage_fp_alltime_same_0.3[[z]][[5]][[j]],
                                        seed = 123, 
                                        chains = 4, 
                                        parallel_chains = 4,
                                        iter_warmup = 1000,
                                        ...
                                        #init = inits,
                                        adapt_delta = 0.99)
    loo_result_0.3 = RickerFit_0.3$loo(cores = numer_cores)
    
    
    RickerFit_origin_0.15 = mod_ricker$sample(data = fit_stage_fp_alltime_same_0.15[[z]][[5]][[j]],
                                              seed = 123, 
                                              chains = 4, 
                                              parallel_chains = 4,
                                              iter_warmup = 1000,
                                              ...
                                              #init = inits,
                                              adapt_delta = 0.99)
    loo_result_origin_0.15 = RickerFit_origin_0.15$loo(cores = numer_cores)
    
    RickerFit_origin_0.20 = mod_ricker$sample(data = fit_stage_fp_alltime_same_0.20[[z]][[5]][[j]],
                                              seed = 123, 
                                              chains = 4, 
                                              parallel_chains = 4,
                                              iter_warmup = 1000,
                                              ...
                                              #init = inits,
                                              adapt_delta = 0.99)
    loo_result_origin_0.20 = RickerFit_origin_0.20$loo(cores = numer_cores)
    
    RickerFit_origin_0.25 = mod_ricker$sample(data = fit_stage_fp_alltime_same_0.25[[z]][[5]][[j]],
                                              seed = 123, 
                                              chains = 4, 
                                              parallel_chains = 4,
                                              iter_warmup = 1000,
                                              ...
                                              #init = inits,
                                              adapt_delta = 0.99)
    loo_result_origin_0.25 = RickerFit_origin_0.25$loo(cores = numer_cores)
    
    RickerFit_origin_0.3 = mod_ricker$sample(data = fit_stage_fp_alltime_same_0.3[[z]][[5]][[j]],
                                        seed = 123, 
                                        chains = 4, 
                                        parallel_chains = 4,
                                        iter_warmup = 1000,
                                        ...
                                        #init = inits,
                                        adapt_delta = 0.99)
    loo_result_origin_0.3 = RickerFit_origin_0.3$loo(cores = numer_cores)
  ...
  save(summary_l, file = paste('results/fit_results/equal_alltime/summary/summary_',
                        unique(growD$f_p),'.rdata',
                        sep = ''))
  save(posterior_l, file = paste('results/fit_results/equal_alltime/posterior/posterior_',
                        unique(growD$f_p),'.rdata',
                        sep = ''))
  ...
  write.table(a_trans_sp_inver, file=paste('results/fit_results/equal_alltime/parameters/a_',
                                           unique(growD$f_p),
                                           ".txt",sep = ''))
  write.table(r_trans_sp, file=paste('results/fit_results/equal_alltime/parameters/r_',
                                     unique(growD$f_p),
                                     ".txt",sep = ''))
  ...
  write.table(intra_trans, file=paste('results/fit_results/equal_alltime/parameters/intra_',
  ...
  write.table(inter_all_trans, file=paste('results/fit_results/equal_alltime/parameters/inter_',
                                          unique(growD$f_p),
                                          ".txt",sep = ''))
