...
for (z in seq(1, 480, by = 24)) {
  #z = 67
  growD_Estab = re_cover_ab_estab_t2_l_f[[z]]
  growD_Intro = re_cover_ab_intro_t2_l_f[[z]]
  growD_Nati = re_cover_ab_nati_t2_l_f[[z]]
  growD_domin = re_cover_ab_domin_t2_l_f[[z]]
  ...
  summary_l = list()
    ...
    for (j in 1:length(sp)) {
      ...
      summary = summary_l[[j]]
      write.table(summary, paste('D:/BSS study/results/time_sep/summary/',unique(growD$f_p), '_', sp[j], '_t2.txt', sep = ''))
    }
    ...
    write.table(intra_trans, file=paste('D:/BSS study/results/time_sep/parameters/intra_',unique(growD$f_p), "_t2.txt",sep = ''))
    ...
    write.table(inter_all_trans, file=paste('D:/BSS study/results/time_sep/parameters/inter_',unique(growD$f_p), "_t2.txt",sep = ''))
