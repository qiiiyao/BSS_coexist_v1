...
# Fit
load('code/data preparation/fit_stage_fp_t1.rdata')
for (z in 1:length(inva_stage_fp_t1)) {
  #z = 1
  datalist = inva_stage_fp_t1[[z]][[4]]
  growD = inva_stage_fp_t1[[z]][[3]]
  ...
  save(summary_l, file = paste('results/fit_results/equal_moving_win/equal_t1/summary/summary_',
                               unique(growD$f_p),'.rdata',
                               sep = ''))
  save(posterior_l, file = paste('results/fit_results/equal_moving_win/equal_t1/posterior/posterior_',
                                 unique(growD$f_p),'.rdata',
                                 sep = ''))
  ...
  write.table(a_trans_sp_inver, file=paste('results/fit_results/equal_moving_win/equal_t1/parameters/a_',
                                           unique(growD$f_p),
                                           ".txt",sep = ''))
  write.table(r_trans_sp, file=paste('results/fit_results/equal_moving_win/equal_t1/parameters/r_',
                                     unique(growD$f_p),
                                     ".txt",sep = ''))
  ...
  write.table(intra_trans, file=paste('results/fit_results/equal_moving_win/equal_t1/parameters/intra_',
  ...
  write.table(inter_all_trans, file=paste('results/fit_results/equal_moving_win/equal_t1/parameters/inter_',
                                          unique(growD$f_p),
                                          ".txt",sep = ''))
