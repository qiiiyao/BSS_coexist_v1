...
parameters {
  ...
  vector<lower=0>[S] raw_response; // species-specific effect parameter (r in the manuscript but without weight)
  vector<lower=0>[T] raw_effect;   // species-specific effect parameter (e in the manuscript)
