...
do
    ...
    echo "$script_content" > "${i}.bh_allb.sh"
done
...
for i in $(seq 54547 54552)
do
    bkill "${i}"
done

cd /data/home/shpli3/R_projects/BSS_exclude_tree_raw/fit_results/plot_ages1_35_top50_equal_interval_model_comparison/bh_allb
