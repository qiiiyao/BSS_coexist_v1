...
do
    ...
    echo "$script_content" > "${i}.bh_partialb_top30.sh"
done

for i in $(seq 1 10)
do
    qsub "${i}.bh_partialb_top30.sh"
done
...
cd /data/home/shpli3/R_projects/BSS_exclude_tree_raw/fit_results/plot_ages1_35_top50_equal_interval_model_comparison/bh_partialb_top30
