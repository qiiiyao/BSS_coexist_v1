...
############### Fast Start ####################
rm(list = ls())
load("D:/R projects/BSS/results/fit_results/BSS_exculde_trees_raw/ranfield_ages1_51_top50/inter_all_c_fp_alltime.rdata")
...
library(ape)
library(reticulate)
inter_all_c = inter_all_c_fp_alltime
