...
save(dat_all_alltime, 
     file = 'results/fit_results/BSS_exclude_trees_raw/plot_sameages_top50/dat_all_alltime.rdata')
rm(list = ls()) ### free the memory

############### Fast Start ####################
rm(list = ls())
load("results/fit_results/BSS_exclude_trees_raw/plot_sameages_top50/inter_all_c_alltime.rdata")
...
save(lincombs.data.nd.a.pd.a, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.nd.a.pd.a.rdata')
...
save(lincombs.data.lgfd.a.pd.a, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.lgfd.a.pd.a.rdata')
...
save(lincombs.data.ablgfd.a.pd.a, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.ablgfd.a.pd.a.rdata')
...
save(lincombs.data.nd.a.conti_func_d.a, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.nd.a.conti_func_d.a.rdata')
...
save(lincombs.data.lgfd.a.conti_func_d.a, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.lgfd.a.conti_func_d.a.rdata')
...
save(lincombs.data.ablgfd.a.conti_func_d.a, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.ablgfd.a.conti_func_d.a.rdata')
...
save(lincombs.data.nd.a.func_d.a, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.nd.a.func_d.a.rdata')
...
save(lincombs.data.lgfd.a.func_d.a, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.lgfd.a.func_d.a.rdata')
...
save(lincombs.data.ablgfd.a.func_d.a, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.ablgfd.a.func_d.a.rdata')
...
save(lincombs.data.nd.pd, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.nd.pd.rdata')
...
save(lincombs.data.lgfd.pd, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.lgfd.pd.rdata')
...
save(lincombs.data.ablgfd.pd, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.ablgfd.pd.rdata')
...
save(lincombs.data.nd.conti_func_d, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.nd.conti_func_d.rdata')
...
save(lincombs.data.lgfd.conti_func_d, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.lgfd.conti_func_d.rdata')
...
save(lincombs.data.ablgfd.conti_func_d, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.ablgfd.conti_func_d.rdata')
...
save(lincombs.data.nd.func_d, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.nd.func_d.rdata')
...
save(lincombs.data.lgfd.func_d, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.lgfd.func_d.rdata')
...
save(lincombs.data.ablgfd.func_d, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.ablgfd.func_d.rdata')
...
save(lincombs.data.nnd.ntd, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.nnd.ntd.rdata')
...
save(lincombs.data.nlgfd.ntd, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.nlgfd.ntd.rdata')
...
save(lincombs.data.nablgfd.ntd, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.nablgfd.ntd.rdata')
...
save(lincombs.data.nnd.nconti_func_d, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.nnd.nconti_func_d.rdata')
...
save(lincombs.data.nlgfd.nconti_func_d, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.nlgfd.nconti_func_d.rdata')
...
save(lincombs.data.nablgfd.nconti_func_d, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.nablgfd.nconti_func_d.rdata')
...
save(lincombs.data.nnd.nfunc_d, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.nnd.nfunc_d.rdata')
...
save(lincombs.data.nlgfd.nfunc_d, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.nlgfd.nfunc_d.rdata')
...
save(lincombs.data.nablgfd.nfunc_d, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.nablgfd.nfunc_d.rdata')
...
(estab.mpd.a_single.logistic=ggplot(data=lincombs.data.estab.mpd.a_single,aes(x=mpd.a_all, y=predicted.value))+
    ...
    annotate(geom="text",x=c(200,200),y=c(0.80,0.70),
             label=c("italic(β)['MPD'[ab]] == '-0.0048'",
                     "'95%CI' == '[-0.0091, -0.0004]'"),
             parse=T,size=3.5)+
    theme_regular()
)
...
(estab.mfunc_d.a_single.logistic=ggplot(data=lincombs.data.estab.mfunc_d.a_single,
    ...
    annotate(geom="text",x=c(0.3,0.3),y=c(0.80,0.70),
             label=c("italic(β)['MFD'[ab]] == -3.98", "'95%CI' == '[-5.77, -2.18]'"),
             parse=T,size=3.5)+
    theme_regular()
)
...
inla.model_lincombs.domin.mpd.a_single$inla.model$summary.fixed[c(1,3,5)]%>%round(6)##Extracting effects and confidence intervals for prediction curves from raw data
...
save(lincombs.data.estab.mnd.a, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.estab.mnd.a.rdata')
...
load("code/results_analyzing/analysing_sameages_top50_data/lincombs.data.estab.mnd.a.rdata")
library(scales)
...
save(lincombs.data.estab.mlgfd.a, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.estab.mlgfd.a.rdata')
...
load("code/results_analyzing/analysing_sameages_top50_data/lincombs.data.estab.mlgfd.a.rdata")
...
save(lincombs.data.domin.mnd.a, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.domin.mnd.a.rdata')
...
load("code/results_analyzing/analysing_sameages_top50_data/lincombs.data.domin.mnd.a.rdata")
...
save(lincombs.data.domin.mlgfd.a, 
     file = 'code/results_analyzing/analysing_sameages_top50_data/lincombs.data.domin.mlgfd.a.rdata')
...
load("code/results_analyzing/analysing_sameages_top50_data/lincombs.data.domin.mlgfd.a.rdata")
