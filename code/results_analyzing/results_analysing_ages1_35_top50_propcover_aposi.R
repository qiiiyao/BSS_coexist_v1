...
load("D:/R projects/BSS/results/fit_results/BSS_exclude_trees_raw/plot_ages1_35_top50_propcover_aposi/ricker/inter_all_c_alltime.rdata")
...
colnames(inter_all_forestab_msd_2) = c('stage', 'nd_mean', 'fd_mean',
                                     'nd_sd',
                                     'fd_sd')

Fig.1_compare_estab_original_2 = ggplot(NULL) +
  geom_point(data = inter_all_forestab, aes(x = ni_mean, y = fi_mean,
                                            color = stage_ij_estab,
                                            shape = stage_ij_estab,
                                            alpha = stage_ij_estab),
             size = 1)+
...
colnames(inter_all_fordomin_msd_2) = c('stage', 'nd_mean', 'fd_mean',
                                       'nd_sd',
                                       'fd_sd')

Fig.1_compare_domin_original_2 = ggplot(NULL) +
  geom_point(data = inter_all_fordomin, aes(x = ni_mean, y = fi_mean,
                                            color = stage_ij_domin,
                                            shape = stage_ij_domin,
                                            alpha = stage_ij_domin),
             size = 1)+
  geom_pointrange(data = inter_all_fordomin_msd_2,
                  mapping = aes(x = nd_mean,y = fd_mean,
                                ymin = fd_mean-fd_sd,
                                ymax = fd_mean+fd_sd,
                                color = stage,
  ...
  scale_color_manual(values = c(colors_2d[1],
                                colors_2d[2]),
                     labels = c("intro.domin_native" = "Successful",
                                "intro.nodomin_native" = "Failed"),
                     name = ' ')+
  scale_shape_manual(values = c(16,1),
                     labels = c("intro.domin_native" = "Successful",
                                "intro.nodomin_native" = "Failed"),
  ...
  theme_for_coe_plot() + 
  theme(legend.position = c(0.18, 0.12))
Fig.1_compare_domin_original_2
...
(estab_nd_rfd.a.all.varied.intercept.plot =
    ...
    scale_color_manual(values = c(colors_4d[1],
                       ...
                       labels = c("MND.ab" = "MND.ab",
                                  "MRFD.ab" = "MRFD.ab"),
                       name = ' ')+
    annotate(geom="text", x=0.27, y=2.5, family = 'Arial',
             label='Establishment')+
    labs(x = '  ', y = '  ')+
    guides(color="none")+
    theme_regular())
...
(domin_nd_rfd.a.all.varied.intercept.plot =
    ...
    scale_color_manual(values = c(colors_4d[1],
                       ...
                       labels = c("MND.ab" = "MND.ab",
                                  "MRFD.ab" = "MRFD.ab"),
                       name = ' ')+
    annotate(geom="text", x=0.22, y=2.5, family = 'Arial',
             label='Dominance')+
...
emf('results/figures_ages1_35_top50_aposi/all_species_d/Fig.1.md.emf',
...
Fig.1.all
emf('results/figures_ages1_35_top50_aposi/Fig.1.all.emf',
