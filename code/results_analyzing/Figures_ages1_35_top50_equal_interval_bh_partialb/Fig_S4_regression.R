...
load("results/fit_results/BSS_exclude_trees_raw/plot_ages1_35_top50_equal_interval_model_comparison/bh_partialb_top30/inter_all_c_alltime_newfd.rdata")
...
#### Fig.S4：BH model results for demonstration of how Weighted Mean ND/RFD affects successful colonization and dominance of species, including presentation of raw data and single & multi-regression results ####
library(ggpubr)
library(export)
library(devEMF)
library(cowplot)
...
Fig.S4.all
emf('results/figures_ages1_35_top50_equal_interval_bh_partialb/Fig.S4.emf',
