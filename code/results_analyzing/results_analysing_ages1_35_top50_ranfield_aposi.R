...
rm(list = ls())
load("D:/R projects/BSS/results/fit_results/BSS_exclude_trees_raw/ran_t_f_ages1_35_top50_normal_posi/inter_all_c_alltime_new.rdata")
...
inter_all_forestab_msd_2 = inter_all_forestab %>% 
 group_by(stage_ij_estab) %>% summarise_at(vars(nd, fd),
                                          c(mean, sd), na.rm = T)
colnames(inter_all_forestab_msd_2) = c('stage', 'nd_mean', 'fd_mean', 'nd_sd',
                                     'fd_sd')
...
Fig.1_compare_estab_original = ggplot(NULL) +
  ...
  scale_shape_manual(values = c(16,1),
                     labels = c("intro.estab_native" = "Successful",
                                "intro.noestab_native" = "Failed"),
                     name = ' ')+
  coord_cartesian(xlim=c(-10, 10),ylim=c(-25, 10))+ # just control the lab, not the data
...
inter_all_fordomin_msd = inter_all_fordomin %>% 
  group_by(stage_ij_domin) %>% summarise_at(vars(ni_mean, fi_mean),
                                            c(mean, sd), na.rm = T)

colnames(inter_all_fordomin_msd) = c('stage', 'nd_mean2',
                                     'fd_mean2', 'nd_sd2',
                                     'fd_sd2')
#inter_all_fordomin_msd_2 = inter_all_fordomin %>% 
...
for (i in 1:length(inter_all_c_l_2)) {
  ...
  for (j in 1:length(inv_sp)) {
    ...
    mnd = mean(inv_suc_sp$nd_mean)
    mfd = mean(inv_suc_sp$fd_mean)
    mdemo_ratio = mean(inv_suc_sp$demo_ratio_mean)
    mcomp_ratio = mean(inv_suc_sp$comp_ratio_mean)
    ...
    mnd.a = sum(inv_suc_sp$nd_mean*inv_suc_sp$ra_m_real_t_i*inv_suc_sp$ra_m_real_t_j)/sum(inv_suc_sp$ra_m_real_t_i*inv_suc_sp$ra_m_real_t_j)
    mfd.a = sum(inv_suc_sp$fd_mean*inv_suc_sp$ra_m_real_t_i*inv_suc_sp$ra_m_real_t_j)/sum(inv_suc_sp$ra_m_real_t_i*inv_suc_sp$ra_m_real_t_j)
    mdemo_ratio.a = sum(inv_suc_sp$demo_ratio_mean*inv_suc_sp$ra_m_real_t_i*inv_suc_sp$ra_m_real_t_j)/sum(inv_suc_sp$ra_m_real_t_i*inv_suc_sp$ra_m_real_t_j)
    mcomp_ratio.a = sum(inv_suc_sp$comp_ratio_mean*inv_suc_sp$ra_m_real_t_i*inv_suc_sp$ra_m_real_t_j)/sum(inv_suc_sp$ra_m_real_t_i*inv_suc_sp$ra_m_real_t_j)
    ...
    mnnd = min(inv_suc_sp$nd_mean)
    mnfd = min(inv_suc_sp$fd_mean)
    mndemo_ratio = min(inv_suc_sp$demo_ratio_mean)
    mncomp_ratio = min(inv_suc_sp$comp_ratio_mean)
    ...
    dat_suc_sp_1 = data.frame(f_p = unique(trans_plot$f_p), plot = unique(trans_plot$f_p),
                              ...
                              mnd = mnd, mfd = mfd, mdemo_ratio = mdemo_ratio,
...
str(dat_suc_sp)
save(dat_suc_sp,
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/dat_suc_sp.rdata')
...
save(mod_sp_all_md_brms,
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/mod_sp_all_md_brms.rdata')
...
save(mod_sp_all_md.a_brms,
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/mod_sp_all_md.a_brms.rdata')
...
save(mod_sp_all_mnd_brms,
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/mod_sp_all_mnd_brms.rdata')
...
load('code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/dat_suc_sp.rdata')
...
save(lincombs.data.nd.a.pd.a, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.nd.a.pd.a.rdata')
...
save(lincombs.data.fd.a.pd.a, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.fd.a.pd.a.rdata')
...
save(lincombs.data.abfd.a.pd.a, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.abfd.a.pd.a.rdata')
...
save(lincombs.data.nd.a.conti_func_d.a, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.nd.a.conti_func_d.a.rdata')
...
save(lincombs.data.fd.a.conti_func_d.a, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.fd.a.conti_func_d.a.rdata')
...
save(lincombs.data.abfd.a.conti_func_d.a, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.abfd.a.conti_func_d.a.rdata')
...
save(lincombs.data.nd.a.func_d.a, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.nd.a.func_d.a.rdata')
...
save(lincombs.data.fd.a.func_d.a, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.fd.a.func_d.a.rdata')
...
save(lincombs.data.abfd.a.func_d.a, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.abfd.a.func_d.a.rdata')
...
save(lincombs.data.nd.pd, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.nd.pd.rdata')
...
save(lincombs.data.fd.pd, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.fd.pd.rdata')
...
save(lincombs.data.abfd.pd, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.abfd.pd.rdata')
...
save(lincombs.data.nd.conti_func_d, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.nd.conti_func_d.rdata')
...
save(lincombs.data.fd.conti_func_d, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.fd.conti_func_d.rdata')
...
save(lincombs.data.abfd.conti_func_d, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.abfd.conti_func_d.rdata')
...
save(lincombs.data.nd.func_d, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.nd.func_d.rdata')
...
save(lincombs.data.fd.func_d, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.fd.func_d.rdata')
...
save(lincombs.data.abfd.func_d, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.abfd.func_d.rdata')
...
save(lincombs.data.nnd.ntd, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.nnd.ntd.rdata')
...
save(lincombs.data.nfd.ntd, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.nfd.ntd.rdata')
...
save(lincombs.data.nabfd.ntd, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.nabfd.ntd.rdata')
...
save(lincombs.data.nnd.nconti_func_d, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.nnd.nconti_func_d.rdata')
...
save(lincombs.data.nfd.nconti_func_d, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.nfd.nconti_func_d.rdata')
...
save(lincombs.data.nabfd.nconti_func_d, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.nabfd.nconti_func_d.rdata')
...
save(lincombs.data.nnd.nfunc_d, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.nnd.nfunc_d.rdata')
...
save(lincombs.data.nfd.nfunc_d, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.nfd.nfunc_d.rdata')
...
save(lincombs.data.nabfd.nfunc_d, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.nabfd.nfunc_d.rdata')
...
ggsave(plot = plo_mnd.a_mabfd.a_traits,
       'results/figures_sameages_top50/plo_mnd.a_mabfd.a_traits.jpg',
...
save(lincombs.data.estab.mnd.a_single, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mnd.a_single.rdata')
...
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mnd.a_single.rdata")
(estab.mnd.a_single.logistic=ggplot(data=lincombs.data.estab.mnd.a_single,
    ...
    annotate(geom="text",x=c(7,7),y=c(0.90,0.80),
             label=c("italic(β)['ND'[ab]] == '-0.008'",
                     "'95%CI' == '[-0.063, 0.047]'"),
             parse=T,size=3.5)+
    theme_regular()
)
...
inla.model_lincombs.estab.mfd.a_single$inla.model$summary.fixed[c(1,3,5)]%>%round(3)##Extracting effects and confidence intervals for prediction curves from raw data
...
save(lincombs.data.estab.mfd.a_single, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mfd.a_single.rdata')
...
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mfd.a_single.rdata")
(estab.mfd.a_single.logistic=ggplot(data=lincombs.data.estab.mfd.a_single,aes(x=mfd.a, y=predicted.value))+
    ...
    geom_point(data=dat_suc_sp, aes(x=mfd.a, y=estab),
               ...
               position=position_jitter(height=0.02))+
    labs(x=' ', y=' ')+
    annotate(geom="text",x=c(-250,-250),y=c(0.20,0.10),
             label=c("italic(β)['RFD'[ab]] == '-0.017'",
                     "'95%CI' == '[-0.018, -0.015]'"),
             parse=T,size=3.5)+
    theme_regular()
)
#mfd.a      0.37       0.13       0.61
...
save(lincombs.data.estab.mpd.a_single, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mpd.a_single.rdata')
...
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mpd.a_single.rdata")
...
save(lincombs.data.estab.mfunc_d.a_single, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mfunc_d.a_single.rdata')
...
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mfunc_d.a_single.rdata")
(estab.mfunc_d.a_single.logistic=ggplot(data=lincombs.data.estab.mfunc_d.a_single,
    ...
    annotate(geom="text",x=c(0.25,0.25),y=c(0.9,0.80),
             label=c("italic(β)['MFD'[ab]] == '-2.7210'",
                     "'95%CI' == '[-3.5984, -1.8433]'"),
             parse=T,size=3.5)+
    theme_regular()
)
...
inla.model_lincombs.domin.mnd.a_single$inla.model$summary.fixed[c(1,3,5)]%>%round(3)##Extracting effects and confidence intervals for prediction curves from raw data
...
save(lincombs.data.domin.mnd.a_single, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mnd.a_single.rdata')
...
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mnd.a_single.rdata")
(domin.mnd.a_single.logistic=ggplot(data=lincombs.data.domin.mnd.a_single,aes(x=mnd.a, y=predicted.value))+
    ...
    annotate(geom="text",x=c(4, 4),y=c(0.90, 0.80),
             label=c("italic(β)['ND'[ab]] == '-0.215'",
                     "'95%CI' == '[-0.367, -0.063]'"),
             parse=T,size=3.5)+
    theme_regular()
)
...
inla.model_lincombs.domin.mfd.a_single$inla.model$summary.fixed[c(1,3,5)]%>%round(3)##Extracting effects and confidence intervals for prediction curves from raw data
...
save(lincombs.data.domin.mfd.a_single, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mfd.a_single.rdata')
...
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mfd.a_single.rdata")
(domin.mfd.a_single.logistic=ggplot(data=lincombs.data.domin.mfd.a_single,aes(x=mfd.a, y=predicted.value))+
    ...
    annotate(geom="text",x=c(-250,-250),y=c(0.20,0.10),
             label=c("italic(β)['RFD'[ab]] == '-0.013'",
                     "'95%CI' == '[-0.015, -0.011]'"),
             parse=T,size=3.5)+
    theme_regular()
)
#mfd.a      2.22       1.58       2.86
...
save(lincombs.data.domin.mpd.a_single, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mpd.a_single.rdata')
...
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mpd.a_single.rdata")
(domin.mpd.a_single.logistic=ggplot(data=lincombs.data.domin.mpd.a_single,aes(x=mpd.a_all, y=predicted.value))+
    ...
    annotate(geom="text",x=c(200,200),y=c(0.90,0.80),
             label=c("italic(β)['MPD'[ab]] == '-0.0034'", "'95%CI' == '[-0.0065, -0.0004]'"),
             parse=T,size=3.5)+
    theme_regular()
)
...
save(lincombs.data.domin.mfunc_d.a_single, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mfunc_d.a_single.rdata')
...
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mfunc_d.a_single.rdata")
(domin.mfunc_d.a_single.logistic=ggplot(data=lincombs.data.domin.mfunc_d.a_single,
    ...
    annotate(geom="text",x=c(0.25,0.25),y=c(0.90,0.80),
             label=c("italic(β)['MFD'[ab]] == '5.9325'",
                     "'95%CI' == '[4.1965, 7.6573]'"),
             parse=T,size=3.5)+
    theme_regular()
)
...
inla.model_lincombs.estab.mnd_single$inla.model$summary.fixed[c(1,3,5)]%>%round(3)##Extracting effects and confidence intervals for prediction curves from raw data
...
save(lincombs.data.estab.mnd_single, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mnd_single.rdata')
...
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mnd_single.rdata")
...
lincombs.data.estab.mfd_single = data.frame(mfd=seq(min(dat_suc_sp$mfd),
                                                        max(dat_suc_sp$mfd),
                                                        length=100))

lincombs.matrix.estab.mfd_single=model.matrix(~mfd,
                                                data=lincombs.data.estab.mfd_single)
lincombs.matrix.estab.mfd_single=as.data.frame(lincombs.matrix.estab.mfd_single)
lincombs.estab.mfd_single=inla.make.lincombs(lincombs.matrix.estab.mfd_single)

inla.model_lincombs.estab.mfd_single = pglmm(estab ~ mfd+#(1|species) + 
                                                 (1|f_p) + (1|field), data = dat_suc_sp,
                                               family = "binomial", cov_ranef = list(species = tree),
                                               bayes_options = list(control.compute = list(dic=T,waic=T,cpo=T,
                                                                                           config = TRUE),
                                                                    quantiles=c(0.025,0.5,0.975),
                                                                    lincomb=lincombs.estab.mfd_single,
                                                                    control.predictor=list(compute=T)),
                                               bayes = T)

lincombs.posterior.estab.mfd_single = inla.model_lincombs.estab.mfd_single$inla.model$marginals.lincomb.derived[c(1:100)]
inla.model_lincombs.estab.mfd_single$inla.model$summary.fixed[c(1,3,5)]%>%round(3)##Extracting effects and confidence intervals for prediction curves from raw data

#inla.model1_lincombs.estab.nd$summary.lincomb,This is logit scale, can not be used directly, 
# you need to use the posterior distribution to the original scale, 
# and then calculate the mean and confidence. The following method:
lincombs.data.estab.mfd_single$predicted.value=unlist(lapply(lincombs.posterior.estab.mfd_single,function(x)inla.emarginal(fun=plogis,x)))
lincombs.data.estab.mfd_single$lower=unlist(lapply(lincombs.posterior.estab.mfd_single,function(x)inla.qmarginal(0.025,inla.tmarginal(fun=plogis,x))))
lincombs.data.estab.mfd_single$upper=unlist(lapply(lincombs.posterior.estab.mfd_single,function(x)inla.qmarginal(0.975,inla.tmarginal(fun=plogis,x))))
#lincombs.data.estab.mfd_single
save(lincombs.data.estab.mfd_single, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mfd_single.rdata')
...
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mfd_single.rdata")
(estab.mfd_single.logistic=ggplot(data=lincombs.data.estab.mfd_single,aes(x=mfd, y=predicted.value))+
    geom_ribbon(aes(ymin=lower,ymax=upper),
                fill=stata_pal("s2color")(4)[2],alpha=0.2)+
    geom_line(color=stata_pal("s2color")(4)[2],size=1,
              linetype = 1)+
    ...
    geom_point(data=dat_suc_sp, aes(x=mfd, y=estab),
               ...
               position=position_jitter(height=0.02))+
    labs(x=' ', y=' ')+
    annotate(geom="text",x=c(-120,-120),y=c(0.90,0.80),
             label=c("italic(β)['RFD'] == '-0.016'",
                     "'95%CI' == '[-0.017, -0.015]'"),
             parse=T,size=3.5)+
    theme_regular()
)
...
save(lincombs.data.estab.mpd_single, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mpd_single.rdata')
...
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mpd_single.rdata")
...
save(lincombs.data.estab.mfunc_d_single, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mfunc_d_single.rdata')
...
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mfunc_d_single.rdata")
(estab.mfunc_d_single.logistic=ggplot(data=lincombs.data.estab.mfunc_d_single,
    ...
    annotate(geom="text",x=c(0.3,0.3),y=c(0.9,0.80),
             label=c("italic(β)['MFD'] == '7.0387'",
                     "'95%CI' == '[6.0846, 7.993]'"),
             parse=T,size=3.5)+
    theme_regular()
)
#mfunc_d_all  7.0387     6.0846     7.993


##### dominance predictive curves for md #####
### get dominance predict data for mnd
lincombs.data.domin.mnd_single = data.frame(mnd=seq(min(dat_suc_sp$mnd),
                                                    max(dat_suc_sp$mnd),
                                                    length=100))
...
inla.model_lincombs.domin.mnd_single$inla.model$summary.fixed[c(1,3,5)]%>%round(3)##Extracting effects and confidence intervals for prediction curves from raw data
...
save(lincombs.data.domin.mnd_single, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mnd_single.rdata')
...
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mnd_single.rdata")
(domin.mnd_single.logistic=ggplot(data=lincombs.data.domin.mnd_single,aes(x=mnd, y=predicted.value))+
    ...
    scale_color_gradient(low = turbo(4)[2],
                         high = turbo(4)[1])+
    #theme(plot.margin=unit(c(0.4,0,0.4,0.4),units="lines"))+
    geom_point(data=dat_suc_sp, aes(x=mnd, y=domin),
               color = stata_pal("s2color")(4)[3],
               shape=1,
               alpha = 0.2,
               position=position_jitter(height=0.02))+
    labs(x='Niche difference (ND)', y='Dominance probability')+
    annotate(geom="text",x=c(2,2),y=c(0.90,0.80),
             label=c("italic(β)['ND'] == '-0.036'",
                     "'95%CI' == '[-0.148, 0.077]'"),
             parse=T,size=3.5)+
    theme_regular()
)
#mnd         -0.036     -0.148      0.077



### get dominance predict data for mfd
lincombs.data.domin.mfd_single = data.frame(mfd=seq(min(dat_suc_sp$mfd),
                                                        max(dat_suc_sp$mfd),
                                                        length=100))

lincombs.matrix.domin.mfd_single=model.matrix(~mfd,
                                                data=lincombs.data.domin.mfd_single)
lincombs.matrix.domin.mfd_single=as.data.frame(lincombs.matrix.domin.mfd_single)
lincombs.domin.mfd_single=inla.make.lincombs(lincombs.matrix.domin.mfd_single)

inla.model_lincombs.domin.mfd_single = pglmm(domin ~ mfd+#(1|species) + 
                                                 (1|f_p) + (1|field), data = dat_suc_sp,
                                               family = "binomial", cov_ranef = list(species = tree),
                                               bayes_options = list(control.compute = list(dic=T,waic=T,cpo=T,
                                                                                           config = TRUE),
                                                                    quantiles=c(0.025,0.5,0.975),
                                                                    lincomb=lincombs.domin.mfd_single,
                                                                    control.predictor=list(compute=T)),
                                               bayes = T)

lincombs.posterior.domin.mfd_single = inla.model_lincombs.domin.mfd_single$inla.model$marginals.lincomb.derived[c(1:100)]
inla.model_lincombs.domin.mfd_single$inla.model$summary.fixed[c(1,3,5)]%>%round(3)##Extracting effects and confidence intervals for prediction curves from raw data

#inla.model1_lincombs.domin.nd$summary.lincomb,This is logit scale, can not be used directly, 
# you need to use the posterior distribution to the original scale, 
# and then calculate the mean and confidence. The following method:
lincombs.data.domin.mfd_single$predicted.value=unlist(lapply(lincombs.posterior.domin.mfd_single,function(x)inla.emarginal(fun=plogis,x)))
lincombs.data.domin.mfd_single$lower=unlist(lapply(lincombs.posterior.domin.mfd_single,function(x)inla.qmarginal(0.025,inla.tmarginal(fun=plogis,x))))
lincombs.data.domin.mfd_single$upper=unlist(lapply(lincombs.posterior.domin.mfd_single,function(x)inla.qmarginal(0.975,inla.tmarginal(fun=plogis,x))))
#lincombs.data.domin.mfd_single
save(lincombs.data.domin.mfd_single, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mfd_single.rdata')
...
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mfd_single.rdata")
(domin.mfd_single.logistic=ggplot(data=lincombs.data.domin.mfd_single,aes(x=mfd, y=predicted.value))+
    geom_ribbon(aes(ymin=lower,ymax=upper),
                fill=stata_pal("s2color")(4)[2],alpha=0.2)+
    geom_line(color=stata_pal("s2color")(4)[2],size=1,
              linetype = 1)+
    scale_color_gradient(low = turbo(4)[2],
                         high = turbo(4)[1])+
    #theme(plot.margin=unit(c(0.4,0,0.4,0.4),units="lines"))+
    geom_point(data=dat_suc_sp, aes(x=mfd, y=domin),
               color = stata_pal("s2color")(4)[2],
               shape=1,
               alpha = 0.2,
               position=position_jitter(height=0.02))+
    labs(x='Relative fitness difference (RFD)', y='')+
    annotate(geom="text",x=c(-120,-120),y=c(0.90,0.80),
             label=c("italic(β)['RFD'] == '-0.019'",
                     "'95%CI' == '[-0.021 , -0.018]'"),
             parse=T,size=3.5)+
    theme_regular()
)
#mfd         -0.019     -0.021     -0.018
...
save(lincombs.data.domin.mpd_single, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mpd_single.rdata')
...
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mpd_single.rdata")
(domin.mpd_single.logistic=ggplot(data=lincombs.data.domin.mpd_single,aes(x=mpd_all, y=predicted.value))+
    ...
    labs(x='Phylogenetic difference (PD)', y='Dominance probability')+
    annotate(geom="text",x=c(250,250),y=c(0.90,0.80),
             label=c("italic(β)['MPD'] == '-0.0005'",
                     "'95%CI' == '[-0.0187, 0.0173]'"),
             parse=T,size=3.5)+
    theme_regular()
)
#-0.0005    -0.0187     0.0173
...
save(lincombs.data.domin.mfunc_d_single, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mfunc_d_single.rdata')
...
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mfunc_d_single.rdata")
(domin.mfunc_d_single.logistic=ggplot(data=lincombs.data.domin.mfunc_d_single,
    ...
    geom_point(data=dat_dom_sp, aes(x=mfunc_d_all, y=domin),
               ...
               position=position_jitter(height=0.02))+
    labs(x='Functional difference (FD)', y='  ')+
    annotate(geom="text",x=c(0.3,0.3),y=c(0.90,0.80),
             label=c("italic(β)['MFD'] == '8.9759'",
                     "'95%CI' == '[7.1173, 10.8361]'"),
             parse=T,size=3.5)+
    theme_regular()
)
#mfunc_d_all  8.9759     7.1173    10.8361

estab.mnd_single.logistic
estab.mfd_single.logistic
estab.mpd_single.logistic
estab.mfunc_d_single.logistic
domin.mnd_single.logistic
domin.mfd_single.logistic
...
car::vif(
  glmer(estab ~ mnd + mfd + mpd_all + mfunc_d_all + mdemo_ratio + demo_rate +
          (1|f_p)+ (1|field),
        family = binomial, data = dat_suc_sps)
)

car::vif(
  glmer(estab ~ mnd.a + mfd.a + mpd.a_all + mfunc_d.a_all + mdemo_ratio.a + demo_rate +
          (1|f_p)+ (1|field),
        family = binomial, data = dat_suc_sps)
)

car::vif(
  glmer(estab ~ mnnd + mnfd + mntd_all + mnfunc_d_all + mndemo_ratio + demo_rate +
          (1|f_p)+ (1|field),
        family=binomial,data=dat_suc_sps)
)
...
### all functional trait distance
estab_model_md_func_d_all = pglmm(estab~mnd+mfd+
                                    mpd_all+mfunc_d_all+
                                     demo_rate + #(1|species) + 
...
estab_model_md.a_func_d_all = pglmm(estab~mnd.a+mfd.a+
...
estab_model_mnd_func_d_all = pglmm(estab~mnnd+mnfd+
...
estab_model_md_ratio_func_d_all = pglmm(estab~mnd+mdemo_ratio+mcomp_ratio
                                        +mpd_all+mfunc_d_all+
                                          demo_rate+ #+(1|species) + 
                                          (1|f_p) + (1|field), data = dat_suc_sps,
                                        family = "binomial", cov_ranef = list(species = tree),
...
estab_model_md.a_ratio_func_d_all = pglmm(estab~mnd.a+mdemo_ratio.a+mcomp_ratio.a
                                          +mpd.a_all+mfunc_d.a_all+
                                            demo_rate+ #+(1|species) + 
                                            (1|f_p) + (1|field), data = dat_suc_sps,
                                          family = "binomial", cov_ranef = list(species = tree),
...
estab_model_mnd_ratio_func_d_all = pglmm(estab~mnnd+mndemo_ratio+mncomp_ratio
                                         +mntd_all+mnfunc_d_all+
                                           demo_rate+ #+(1|species) + 
                                           (1|f_p) + (1|field), data = dat_suc_sps,
                                         family = "binomial", cov_ranef = list(species = tree),
...
estab_data.inla.md_ratio_func_d.all_intercept = estab_data.inla.md_ratio_func_d.all_intercept1%>%
  mutate(rowname=c("MND","mdemo_ratio", "mcomp_ratio",
                   "MPD_all","MFD_all", "demo_rate"))%>%
  mutate(percent=abs(mean)/sum(abs(mean)))
...
(estab_r_comp_ratio.all.varied.intercept.plot =
    ggplot((data=estab_data.inla.md_ratio_func_d.all_intercept %>% 
              filter(rowname %in% c('mcomp_ratio', 'mdemo_ratio', 'MND'))),
           aes(x=mean,y=rowname,color=rowname))+
    geom_point(size = 2)+
    geom_linerange(aes(xmin=lower,xmax=upper))+
    geom_vline(xintercept=0,linetype=2,color="grey40")+
    scale_y_discrete(limits=c('mcomp_ratio', 'mdemo_ratio', 'MND'),
                     label=c('mcomp_ratio', 'mdemo_ratio', 'MND'))+
    scale_x_continuous(limits=c(-1,1))+
    scale_color_manual(values = c(stata_pal("s2color")(6)[6],
                                  stata_pal("s2color")(6)[5],
                                  stata_pal("s2color")(6)[3]),
                       name = ' ')+
    annotate(geom="text", x=0.6, y=3.5, family = 'Arial',
             label='Establishment')+
...
(estab_r_r_ratio.a.all.varied.intercept.plot =
    ggplot((data=estab_data.inla.md.a_func_d.all_intercept %>% 
              filter(rowname %in% c('mdemo_ratio.a', 'demo_rate'))),
           aes(x=mean,y=rowname,color=rowname))+
    geom_point(size = 2)+
    geom_linerange(aes(xmin=lower,xmax=upper))+
    geom_vline(xintercept=0,linetype=2,color="grey40")+
    scale_y_discrete(limits=c('mdemo_ratio.a', 'demo_rate'),
                     label=c('r_ratio.a','r'))+
    scale_x_continuous(limits=c(-1.5,1.5))+
    scale_color_manual(values = c(stata_pal("s2color")(6)[6],
                                  stata_pal("s2color")(6)[5]),
                       labels = c("mdemo_ratio.a" = "mdemo_ratio.a",
                                  "demo_rate" = "demo_rate"),
                       name = ' ')+
    annotate(geom="text", x=-1.4, y=2.5, family = 'Arial',
             label='Establishment')+
...
save(lincombs.data.estab.mnd, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mnd.rdata')
...
# Draw logistic curve for establishment~mnd
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mnd.rdata")
...
save(lincombs.data.estab.mfd, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mfd.rdata')
...
# Draw logistic curve for establishment ~ mfd
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mfd.rdata")
...
save(lincombs.data.estab.mpd_all, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mpd_all.rdata')
...
# Draw logistic curve for establishment ~ mpd_all
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mpd_all.rdata")
...
save(lincombs.data.estab.mfunc_d_all, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mfunc_d_all.rdata')
...
# Draw logistic curve for establishment ~ mfunc_d_all
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mfunc_d_all.rdata")
...
save(lincombs.data.estab.mnnd, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mnnd.rdata')
...
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mnnd.rdata")
...
save(lincombs.data.estab.mnfd, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mnfd.rdata')
...
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mnfd.rdata")
...
save(lincombs.data.estab.mntd_all, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mntd_all.rdata')
...
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mntd_all.rdata")
...
save(lincombs.data.estab.mnfunc_d_all, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mnfunc_d_all.rdata')
...
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mnfunc_d_all.rdata")
...
save(lincombs.data.estab.mnd.a, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mnd.a.rdata')
...
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mnd.a.rdata")
library(scales)
...
save(lincombs.data.estab.mfd.a, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mfd.a.rdata')
...
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mfd.a.rdata")
...
save(lincombs.data.estab.mpd.a_all, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mpd.a_all.rdata')
...
# Draw logistic curve for establishment ~ mpd.a_all
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mpd.a_all.rdata")
...
save(lincombs.data.estab.mfunc_d.a_all, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mfunc_d.a_all.rdata')
...
# Draw logistic curve for establishment ~ mfunc_d.a_all
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.estab.mfunc_d.a_all.rdata")
...
### all functional trait distance
domin_model_md_func_d_all = pglmm(domin~mnd+mfd+mpd_all+mfunc_d_all+
                                    demo_rate+ #+(1|species) + 
...
domin_model_md.a_func_d_all = pglmm(domin~mnd.a+mfd.a+mpd.a_all+mfunc_d.a_all+
                                      demo_rate+ #+(1|species) + 
                                      (1|f_p) + (1|field), data = dat_dom_sps,
                                    family = "binomial", cov_ranef = list(species = tree),
                                    bayes_options = list(control.compute = list(dic=T,waic=T,cpo=T,
...
domin_model_mnd_func_d_all = pglmm(domin~mnnd+mnfd+mntd_all+mnfunc_d_all+
                                     demo_rate+ #+(1|species) + 
                                     (1|f_p) + (1|field), data = dat_dom_sps,
                                   family = "binomial", cov_ranef = list(species = tree),
                                   bayes_options = list(control.compute = list(dic=T,waic=T,cpo=T,
...
### split fd to demo_ratio and comp_ratio
domin_model_md_ratio_func_d_all = pglmm(domin~mnd+mdemo_ratio+mcomp_ratio
                                  +mpd_all+mfunc_d_all+
                                    demo_rate+ #+(1|species) + 
                                    (1|f_p) + (1|field), data = dat_dom_sps,
                                  family = "binomial", cov_ranef = list(species = tree),
...
domin_model_md.a_ratio_func_d_all = pglmm(domin~mnd.a+mdemo_ratio.a+mcomp_ratio.a
                                    +mpd.a_all+mfunc_d.a_all+
                                      demo_rate+ #+(1|species) + 
                                      (1|f_p) + (1|field), data = dat_dom_sps,
                                    family = "binomial", cov_ranef = list(species = tree),
...
domin_model_mnd_ratio_func_d_all = pglmm(domin~mnnd+mndemo_ratio+mncomp_ratio
                                         +mntd_all+mnfunc_d_all+
                                     demo_rate+ #+(1|species) + 
                                     (1|f_p) + (1|field), data = dat_dom_sps,
                                   family = "binomial", cov_ranef = list(species = tree),
...
save(lincombs.data.domin.mnd, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mnd.rdata')
...
# Draw logistic curve for dominance~mnd
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mnd.rdata")
...
save(lincombs.data.domin.mfd, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mfd.rdata')
...
# Draw logistic curve for dominance ~ mfd
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mfd.rdata")
...
save(lincombs.data.domin.mpd_all, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mpd_all.rdata')
...
# Draw logistic curve for dominance ~ mpd_all
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mpd_all.rdata")
...
save(lincombs.data.domin.mfunc_d_all, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mfunc_d_all.rdata')
...
# Draw logistic curve for dominance ~ mfunc_d_all
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mfunc_d_all.rdata")
...
save(lincombs.data.domin.mnnd, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mnnd.rdata')
...
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mnnd.rdata")
...
save(lincombs.data.domin.mnfd, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mnfd.rdata')
...
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mnfd.rdata")
...
save(lincombs.data.domin.mntd_all, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mntd_all.rdata')
...
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mntd_all.rdata")
...
save(lincombs.data.domin.mnfunc_d_all, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mnfunc_d_all.rdata')
...
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mnfunc_d_all.rdata")
...
save(lincombs.data.domin.mnd.a, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mnd.a.rdata')
...
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mnd.a.rdata")
...
save(lincombs.data.domin.mfd.a, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mfd.a.rdata')
...
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mfd.a.rdata")
...
save(lincombs.data.domin.mpd.a_all, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mpd.a_all.rdata')
...
# Draw logistic curve for dominance ~ mpd.a_all
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mpd.a_all.rdata")
...
save(lincombs.data.domin.mfunc_d.a_all, 
     file = 'code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mfunc_d.a_all.rdata')
...
# Draw logistic curve for dominance ~ mfunc_d.a_all
load("code/results_analyzing/analysing_r_t_f_ages1_35_top50_aposi_data/lincombs.data.domin.mfunc_d.a_all.rdata")
...
emf('results/figures_r_t_f_ages1_35_top50_aposi/all_species_d/Fig.1.md.emf',
    width = 25.2, height = 16.1, coordDPI = 1200, 
    emfPlusFontToPath=T, # setting emfPlusFontToPath=T to 
...
Fig.1.all = ggdraw() +
  ...
  draw_plot(estab_nd_rfd.all.varied.intercept.plot,
            x = 2 * adjusted_plot_width+0.005, y = 1 - adjusted_first_row_height - adjusted_normal_height, width = adjusted_plot_width, height = adjusted_normal_height) +
  draw_plot(domin.mnd_single.logistic,
            x = 0, y = 1 - adjusted_first_row_height - 1.9 * adjusted_normal_height, width = adjusted_plot_width, height = adjusted_normal_height) +
  draw_plot(domin_nd_rfd.all.varied.intercept.plot,
            x = 2 * adjusted_plot_width+0.005, y = 1 - adjusted_first_row_height - 1.9 * adjusted_normal_height, width = adjusted_plot_width, height = adjusted_normal_height)+
  draw_plot(domin.mfd_single.logistic,
...
Fig.1.all
emf('results/figures_r_t_f_ages1_35_top50_aposi/Fig.1.all.emf',
...
Fig.1.coexist
emf('results/figures_r_t_f_ages1_35_top50_aposi/Fig.1.coexist.emf',
    width = 25.2, height = 25.2, coordDPI = 1200, 
    emfPlusFontToPath=T, # setting emfPlusFontToPath=T to 
    # ensure text looks correct on the viewing system
    units = 'cm')
...
Fig.2.all = ggdraw() +
  ...
  draw_plot(estab.mfunc_d_single.logistic, x = plot_width, y = 0.5,
            width = plot_width, height = plot_height) +
  draw_plot(estab_pd_fd.all.varied.intercept.plot, x = 2 * plot_width, y = 0.5,
            width = plot_width,height = plot_height) +
  draw_plot(domin.mpd_single.logistic, x = 0, y = 0.05,
            width = plot_width, height = plot_height) +
  draw_plot(domin.mfunc_d_single.logistic, x = plot_width, y = 0.05, 
            width = plot_width, height = plot_height) +
  draw_plot(domin_pd_fd.all.varied.intercept.plot, x = 2 * plot_width, y = 0.05,
            width = plot_width, height = plot_height) +
  draw_plot_label(
    label = c("(a)", "(b)", "(c)", "(d)", "(e)", "(f)"),
...
Fig.2.all
emf('results/figures_r_t_f_ages1_35_top50_aposi/Fig.2.all.emf',
...
emf('results/figures_r_t_f_ages1_35_top50_aposi/all_species_d/Fig.2.md.a.emf',
...
emf('results/figures_r_t_f_ages1_35_top50_aposi/all_species_d/Fig.2.md.a_single.emf',
    width = 20, height = 20, coordDPI = 1200, 
    emfPlusFontToPath=T, # setting emfPlusFontToPath=T to 
    # ensure text looks correct on the viewing system
    units = 'cm')
...
emf('results/figures_r_t_f_ages1_35_top50_aposi/all_species_d/Fig.2.md.emf',
    width = 20, height = 20, coordDPI = 1200, 
    emfPlusFontToPath=T, # setting emfPlusFontToPath=T to 
    # ensure text looks correct on the viewing system
    units = 'cm')
...
#### Fig.3：Proving the negative effects of ND will be offseted by the demography rate and competition ratio ####
Fig.3 = estab_r_comp_ratio.all.varied.intercept.plot
emf('results/figures_r_t_f_ages1_35_top50_aposi/Fig.3.emf',
...
emf('results/figures_r_t_f_ages1_35_top50_aposi/fitted_species_d/sem_estab_md_plot_all.emf',
...
ggsave(plot = sem_domin_md_plot_all,
       "results/figures_r_t_f_ages1_35_top50_aposi/fitted_species_d/sem_domin_md_plot_all.svg",
       width=9,height=3)
...
emf('results/figures_r_t_f_ages1_35_top50_aposi/fitted_species_d/sem_estab_md.a_plot_all.emf',
...
emf('results/figures_r_t_f_ages1_35_top50_aposi/fitted_species_d/sem_domin_md.a_plot_all.emf',
    width=18, height=6, coordDPI = 1200, 
    emfPlusFontToPath=T, # setting emfPlusFontToPath=T to 
    # ensure text looks correct on the viewing system
    units = 'cm')
...
ggsave(plot = sem_estab_mnd_plot_all,
       "results/figures_r_t_f_ages1_35_top50_aposi/fitted_species_d/sem_estab_mnd_plot_all.svg",
       width=9,height=3)
...
ggsave(plot = sem_domin_mnd_plot_all,
       "results/figures_r_t_f_ages1_35_top50_aposi/fitted_species_d/sem_domin_mnd_plot_all.svg",
       width=9,height=3)
...
estab_sem1_md_all = psem(
  glmmTMB(estab~#mnd+
          ...
          control=glmmTMBControl(optimizer=optim,
                                 optArgs=list(method="BFGS"))),
  glmmTMB(mdemo_ratio~mpd_all+
            mfunc_d_all+
            #(1|species)+
            (1|field)
          #+(1|f_p)
          , family=gaussian, data=dat_suc_sps),
  glmmTMB(mcomp_ratio~mpd_all+
            mfunc_d_all+
            #(1|species)+
            (1|field)
          #+(1|f_p)
...
ggsave(plot = sem_estab_md_all_plot_all,
       "results/figures_r_t_f_ages1_35_top50_aposi/all_species_d/sem_estab_md_all_plot_all.svg",
       width=9,height=3)
...
ggsave(plot = sem_domin_md_all_plot_all,
       "results/figures_r_t_f_ages1_35_top50_aposi/all_species_d/sem_domin_md_all_plot_all.svg",
       width=9,height=3)
...
### Establishment corrected std coefficients in the glmer, following nakagawa 2013 MEE
sd.y_estab_sem1_md_all = sqrt(predict(estab_sem1_md_all[[1]],re.form=NA)%>%var+sum(unlist(VarCorr(estab_sem1_md_all[[1]])))+pi^2/3)
sd.y_estab_sem1_md_all
std.estab_sem1_md_all=unlist(fixef(estab_sem1_md_all[[1]]))[-1]*
  c(sd(dat_suc_sps$mnd),
    sd(dat_suc_sps$mfd),
    sd(dat_suc_sps$mpd_all),
    sd(dat_suc_sps$mfunc_d_all))/sd.y_estab_sem1_md_all
std.estab_sem1_md_all
...
### Dominance corrected std coefficients in the glmer, following nakagawa 2013 MEE
sd.y_domin_sem1_md_all=sqrt(predict(domin_sem1_md_all[[1]],re.form=NA)%>%var+sum(unlist(VarCorr(domin_sem1_md_all[[1]])))+pi^2/3)
sd.y_domin_sem1_md_all
std.domin_sem1_md_all=unlist(fixef(domin_sem1_md_all[[1]]))[-1]*
  c(sd(dat_dom_sps$mnd),
    sd(dat_dom_sps$mfd),
    sd(dat_dom_sps$mpd_all),
    sd(dat_dom_sps$mfunc_d_all))/sd.y_domin_sem1_md_all
std.domin_sem1_md_all
...
### Calculate direct and indirect effects of SEM following Xu Meng (2022) GCB
### Estab
sem_estab_effects_md_all = data.frame(predictor = rep(c('mnd', 'mfd',
                                                          'mpd_all', 'mfunc_d_all'), 3),
...
### Domin
sem_domin_effects_md_all = data.frame(predictor = rep(c('mnd', 'mfd',
                                                          'mpd_all', 'mfunc_d_all'), 3),
                                        type = rep(c('direct', 'indirect', 'total'),
                                                   each = 4),
                                        value = 0,
...
### Space for SEM
sem_estab_md_all_space1 = ggplot(NULL)+theme_void()
sem_estab_md_all_space2 = ggplot(NULL)+theme_void()
# Merge three plots
sem_estab_md_all_plot_all = ggarrange(sem_estab_md_all_space1, sem_estab_md_all_space2,
                                        sem_estab_effects_md_all.dir_indir.mpd_all.plot,
                                        sem_estab_effects_md_all.percent.plot,
                                        nrow = 2, ncol = 2,
                                        heights = c(0.7, 0.3),
...
emf('results/figures_r_t_f_ages1_35_top50_aposi/sem_estab_md_all_plot_all.emf',
    width=16, height=12, coordDPI = 1200, 
    emfPlusFontToPath=T, # setting emfPlusFontToPath=T to 
    # ensure text looks correct on the viewing system
    units = 'cm')
sem_estab_md_all_plot_all
dev.off() #turn off device and finalize file

emf('results/figures_r_t_f_ages1_35_top50_aposi/sem_estab_md_all_percents.emf',
    width=12, height=9, coordDPI = 1200, 
    emfPlusFontToPath=T, # setting emfPlusFontToPath=T to 
    # ensure text looks correct on the viewing system
    units = 'cm')
ggarrange(sem_estab_md_all_space1,
          sem_estab_effects_md_all.percent.plot,
          nrow = 1, ncol = 2,
          heights = c(0.7, 0.3),
          labels = c('(c)', ''),
...
### Space for SEM
sem_domin_md_all_space1 = ggplot(NULL)+theme_void()
sem_domin_md_all_space2 = ggplot(NULL)+theme_void()

# Merge three plots
sem_domin_md_all_plot_all = ggarrange(sem_domin_md_all_space1,sem_domin_md_all_space2,
                                        sem_domin_effects_md_all.dir_indir.mpd_all.plot,
                                        sem_domin_effects_md_all.percent.plot,
                                        nrow = 2, ncol = 2,
                                        heights = c(0.7, 0.3),
...
emf('results/figures_r_t_f_ages1_35_top50_aposi/sem_domin_md_all_plot_all.emf',
    width=16, height=12, coordDPI = 1200, 
    emfPlusFontToPath=T, # setting emfPlusFontToPath=T to 
    # ensure text looks correct on the viewing system
    units = 'cm')
sem_domin_md_all_plot_all
dev.off() #turn off device and finalize file

emf('results/figures_r_t_f_ages1_35_top50_aposi/sem_domin_md_all_percents.emf',
    width=10, height=9, coordDPI = 1200, 
    emfPlusFontToPath=T, # setting emfPlusFontToPath=T to 
    # ensure text looks correct on the viewing system
    units = 'cm')
ggarrange(sem_domin_md_all_space1,
          sem_domin_effects_md_all.percent.plot,
          nrow = 1, ncol = 2,
          heights = c(0.7, 0.3),
          labels = c('(d)', ''),
...
emf('results/figures_r_t_f_ages1_35_top50_aposi/sem_estab_md.a_all_plot_all.emf',
    width=16, height=12, coordDPI = 1200, 
    emfPlusFontToPath=T, # setting emfPlusFontToPath=T to 
    # ensure text looks correct on the viewing system
    units = 'cm')
...
emf('results/figures_r_t_f_ages1_35_top50_aposi/sem_domin_md.a_all_plot_all.emf',
    width=16, height=12, coordDPI = 1200, 
    emfPlusFontToPath=T, # setting emfPlusFontToPath=T to 
    # ensure text looks correct on the viewing system
    units = 'cm')
...
ggsave(plot = sem_estab_mnd_all_plot_all,
       "results/figures_r_t_f_ages1_35_top50_aposi/all_species_d/sem_estab_mnd_all_plot_all.svg",
       width=9,height=3)
...
ggsave(plot = sem_domin_mnd_all_plot_all,
       "results/figures_r_t_f_ages1_35_top50_aposi/all_species_d/sem_domin_mnd_all_plot_all.svg",
       width=9,height=3)
