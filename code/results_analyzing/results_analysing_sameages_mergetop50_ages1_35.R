...
load("results/fit_results/BSS_exclude_trees_raw/plot_ages1_35_top50/inter_all_c_alltime.rdata")
load('results/fit_results/BSS_exclude_trees_raw/plot_sameages_top50/dat_all_alltime.rdata')
...
Fig.1_compare_estab_original = ggplot(NULL) +
    ...
    annotate(geom="text", x=0.18, y=0.28, family = 'Arial',
             label='Establishment')+
    labs(x = ' ', 
...
Fig.1_compare_domin_original = ggplot(NULL) +
    ...
    geom_hline(yintercept=0, linetype="dashed", linewidth=0.3) +
    geom_vline(xintercept=0, linetype="dashed", linewidth=0.3) +
    annotate(geom="text", x=0.15, y=0.28, family = 'Arial',
             label='Dominance')+
...
ggsave(plot = estab_domin_md,
       'results/figures_sameages_top50/fitted_species_d/estab_domin_md.svg',
       width = 10, height = 15,
       dpi = 300, units = 'cm',
       limitsize = F)

ggsave(plot = estab_domin_md.a,
       'results/figures_sameages_top50/fitted_species_d/estab_domin_md.a.svg',
       width = 10, height = 15,
       dpi = 300, units = 'cm',
       limitsize = F)

ggsave(plot = estab_domin_mnd,
       'results/figures_sameages_top50/fitted_species_d/estab_domin_mnd.svg',
       width = 10, height = 15,
       dpi = 300, units = 'cm',
       limitsize = F)
...
estab_model_md_func_d_all = pglmm(estab~mnd+mlgfd+mpd_all+mfunc_d_all+(1|species) + 
                                  ...
                                  bayes_options = list(control.compute = list(dic=T,waic=T,cpo=T,
                                                       ...
                                                       quantiles=c(0.025,0.5,0.975)),
                                  bayes = T)
pglmm(estab~mpd_all+mfunc_d_all+(1|species) + 
        (1|f_p) + (1|field), data = dat_suc_sps,
      family = "binomial", cov_ranef = list(species = tree),
      bayes_options = list(control.compute = list(dic=T,waic=T,cpo=T,
                                                  config = TRUE),
...
estab_model_md.a_func_d_all = pglmm(estab~mnd.a+mlgfd.a+mpd.a_all+mfunc_d.a_all+(1|species) + 
                                    ...
                                    bayes_options = list(control.compute = list(dic=T,waic=T,cpo=T,
                                                         ...
                                                         quantiles=c(0.025,0.5,0.975)),
                                    bayes = T)
pglmm(estab~mpd.a_all+mfunc_d.a_all+(1|species) + 
        (1|f_p) + (1|field), data = dat_suc_sps,
      family = "binomial", cov_ranef = list(species = tree),
      bayes_options = list(control.compute = list(dic=T,waic=T,cpo=T,
                                                  config = TRUE),
...
(estab.mlgfd.partial.logistic=ggplot(data=lincombs.data.estab.mlgfd,aes(x=mlgfd, y=predicted.value))+
    ...
    annotate(geom="text",x=c(0,0),y=c(0.80,0.70),
             label=c("italic(β)['I-N MRFD'] == 2.42",
                     "'95%CI' == '[1.54, 3.30]'"),
             parse=T,size=3.5)
)
...
(estab.mnnd.partial.logistic=ggplot(data=lincombs.data.estab.mnnd,
    ...
    labs(x='Introduced-native niche difference',
         y="Establishment probability")+
    annotate(geom="text",x=c(0.33,0.33),y=c(0.80,0.70),
             label=c("italic(β)['I-N MNND'] == -0.80",
...
(estab.mnlgfd.partial.logistic=ggplot(data=lincombs.data.estab.mnlgfd,aes(x=mnlgfd, y=predicted.value))+
    ...
    labs(x='Introduced-native fitness difference', y='  ')+
    annotate(geom="text",x=c(0,0),y=c(0.80,0.70),
             label=c("italic(β)['I-N MNRFD'] == 1.84",
                     "'95%CI' == '[1.34, 2.35]'"),
             parse=T,size=3.5)
)
...
(estab.mnd.a.partial.logistic=ggplot(data=lincombs.data.estab.mnd.a,
    ...
    labs(x=' ',
         y="Establishment probability")+
    annotate(geom="text",x=c(0.33,0.33),y=c(0.80,0.70),
             label=c("italic(β)['MND'[ab]] == -2.26",
                     "'95%CI' == '[-2.84, -1.67]'"),parse=T,size=3.5)+    
    theme_regular()
)
...
(estab.mlgfd.a.partial.logistic=ggplot(data=lincombs.data.estab.mlgfd.a,aes(x=mlgfd.a, y=predicted.value))+
    ...
    labs(x=' ', y='  ')+
    annotate(geom="text",x=c(0,0),y=c(0.80,0.70),
             label=c("italic(β)['MRFD'[ab]] == 2.55", "'95%CI' == '[1.84, 3.25]'"),
             parse=T,size=3.5)+
    theme_regular()
)
...
(domin.mlgfd.partial.logistic=ggplot(data=lincombs.data.domin.mlgfd,aes(x=mlgfd, y=predicted.value))+
    ...
    annotate(geom="text",x=c(0,0),y=c(0.80,0.70),
             label=c("italic(β)['E-N MRFD'] == 3.36",
                     "'95%CI' == '[1.68, 5.04]'"),
             parse=T,size=3.5)
)
...
(domin.mnnd.partial.logistic=ggplot(data=lincombs.data.domin.mnnd,
    ...
    annotate(geom="text",x=c(-0.25,-0.25),y=c(0.80,0.70),
             label=c("italic(β)['E-N MNND'] == -0.91",
...
(domin.mnlgfd.partial.logistic=ggplot(data=lincombs.data.domin.mnlgfd,aes(x=mnlgfd, y=predicted.value))+
    ...
    labs(x='Established-native fitness difference', y='  ')+
    annotate(geom="text",x=c(-0.25,-0.25),y=c(0.80,0.70),
             label=c("italic(β)['E-N MNRFD'] == 3.41",
                     "'95%CI' == '[2.32, 4.49]'"),
             parse=T,size=3.5)
)
...
(domin.mnd.a.partial.logistic=ggplot(data=lincombs.data.domin.mnd.a,
    ...
    labs(x='Niche difference (ND)',
         y="Dominance probability")+
    annotate(geom="text",x=c(0.33,0.33),y=c(0.80,0.70),
             label=c("italic(β)['MND'[ab]] == -1.01",
                     "'95%CI' == '[-2.14, 0.11]'"),parse=T,size=3.5)+
    theme_regular()
)
...
(domin.mlgfd.a.partial.logistic=ggplot(data=lincombs.data.domin.mlgfd.a,aes(x=mlgfd.a, y=predicted.value))+
    ...
    annotate(geom="text",x=c(0,0),y=c(0.80,0.70),
             label=c("italic(β)['MRFD'[ab]] == 3.83", "'95%CI' == '[2.43, 5.24]'"),
             parse=T,size=3.5)+
    theme_regular()
)
...
emf('results/figures_sameages_top50/all_species_d/Fig.1.md.a.emf',
...
emf('results/figures_sameages_top50/all_species_d/Fig.2.md.a.emf',
...
emf('results/figures_sameages_top50/fitted_species_d/sem_estab_md_plot_all.emf',
...
ggsave(plot = sem_domin_md_plot_all,
       "results/figures_sameages_top50/fitted_species_d/sem_domin_md_plot_all.svg",
       width=9,height=3)
...
emf('results/figures_sameages_top50/fitted_species_d/sem_estab_md.a_plot_all.emf',
...
emf('results/figures_sameages_top50/fitted_species_d/sem_domin_md.a_plot_all.emf',
    width=18, height=6, coordDPI = 1200, 
    emfPlusFontToPath=TRUE, # setting emfPlusFontToPath=TRUE to 
    # ensure text looks correct on the viewing system
    units = 'cm')
...
ggsave(plot = sem_estab_mnd_plot_all,
       "results/figures_sameages_top50/fitted_species_d/sem_estab_mnd_plot_all.svg",
       width=9,height=3)
...
ggsave(plot = sem_domin_mnd_plot_all,
       "results/figures_sameages_top50/fitted_species_d/sem_domin_mnd_plot_all.svg",
       width=9,height=3)
...
ggsave(plot = sem_estab_md_all_plot_all,
       "results/figures_sameages_top50/all_species_d/sem_estab_md_all_plot_all.svg",
       width=9,height=3)
...
ggsave(plot = sem_domin_md_all_plot_all,
       "results/figures_sameages_top50/all_species_d/sem_domin_md_all_plot_all.svg",
       width=9,height=3)
...
emf('results/figures_sameages_top50/all_species_d/sem_estab_md.a_all_plot_all.emf',
    width=18, height=6, coordDPI = 1200, 
    emfPlusFontToPath=TRUE, # setting emfPlusFontToPath=TRUE to 
    # ensure text looks correct on the viewing system
    units = 'cm')
...
emf('results/figures_sameages_top50/all_species_d/sem_domin_md.a_all_plot_all.emf',
    width=18, height=6, coordDPI = 1200, 
    emfPlusFontToPath=TRUE, # setting emfPlusFontToPath=TRUE to 
    # ensure text looks correct on the viewing system
    units = 'cm')
...
ggsave(plot = sem_estab_mnd_all_plot_all,
       "results/figures_sameages_top50/all_species_d/sem_estab_mnd_all_plot_all.svg",
       width=9,height=3)
...
ggsave(plot = sem_domin_mnd_all_plot_all,
       "results/figures_sameages_top50/all_species_d/sem_domin_mnd_all_plot_all.svg",
       width=9,height=3)
