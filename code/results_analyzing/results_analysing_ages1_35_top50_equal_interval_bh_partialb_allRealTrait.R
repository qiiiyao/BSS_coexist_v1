...
load('code/data preparation/Phylo_Func/fd_dat_noloss.rdata')
load('code/data preparation/Phylo_Func/pd.rdata')
...
save(dat_all_alltime, 
     file = 'results/fit_results/plot_ages1_35_top50_equal_interval_model_comparison/dat_all_alltime.rdata')
...
dat_all_alltime_nolosstraits = dat_all_alltime %>% filter(!is.na(Multi_conti_traits))
dat_all_2 = split(dat_all_alltime_nolosstraits, dat_all_alltime_nolosstraits$f_p)
...
str(dat_suc_sp)
save(dat_suc_sp,
    file = 'code/results_analyzing/analysing_ages1_35_top50_equal_interval_bh_partialb_data/allRealTraits/dat_suc_sp.rdata')
...
save(lincombs.data.estab.mpd.a_single, 
     file = 'code/results_analyzing/analysing_ages1_35_top50_equal_interval_bh_partialb_data/allRealTraits/lincombs.data.estab.mpd.a_single.rdata')
...
load("code/results_analyzing/analysing_ages1_35_top50_equal_interval_bh_partialb_data/allRealTraits/lincombs.data.estab.mpd.a_single.rdata")
ggthemr::ggthemr(palette = "fresh", layout = "clean")
...
save(lincombs.data.estab.mconti_func_d.a_single, 
     file = 'code/results_analyzing/analysing_ages1_35_top50_equal_interval_bh_partialb_data/allRealTraits/lincombs.data.estab.mconti_func_d.a_single.rdata')
...
load("code/results_analyzing/analysing_ages1_35_top50_equal_interval_bh_partialb_data/allRealTraits/lincombs.data.estab.mconti_func_d.a_single.rdata")
ggthemr::ggthemr(palette = "fresh", layout = "clean")
(estab.mconti_func_d.a_single.logistic=ggplot(data=lincombs.data.estab.mconti_func_d.a_single,
    ...
    annotate(geom="text",
             ...
             y=c(0.9,0.77),
             label=c("italic(β)['MFD'[ab]] == '-0.7466'",
                     "'95% CI' == '[-0.8915, -0.6018]'"),
             parse=T,size=5, hjust = 0)+
    theme_regular_1()
)

#mconti_func_d.a_all -0.7466    -0.8915    -0.6018
...
save(lincombs.data.domin.mpd.a_single, 
     file = 'code/results_analyzing/analysing_ages1_35_top50_equal_interval_bh_partialb_data/allRealTraits/lincombs.data.domin.mpd.a_single.rdata')
...
load("code/results_analyzing/analysing_ages1_35_top50_equal_interval_bh_partialb_data/allRealTraits/lincombs.data.domin.mpd.a_single.rdata")
ggthemr::ggthemr(palette = "fresh", layout = "clean")
(domin.mpd.a_single.logistic=ggplot(data=lincombs.data.domin.mpd.a_single,aes(x=mpd.a_all, y=predicted.value))+
    ...
    annotate(geom="text",
             ...
             y=c(0.90,0.77),
             label=c("italic(β)['MPD'[ab]] == '-0.0029'",
                     "'95% CI' == '[-0.0059, 0.0001]'"),
             parse=T,size=5, hjust = 0)+
    theme_regular_1() 
)
#mpd.a_all   -0.0029    -0.0059     0.0001
...
save(lincombs.data.domin.mfunc_d.a_single, 
     file = 'code/results_analyzing/analysing_ages1_35_top50_equal_interval_bh_partialb_data/allRealTraits/lincombs.data.domin.mfunc_d.a_single.rdata')
...
load("code/results_analyzing/analysing_ages1_35_top50_equal_interval_bh_partialb_data/allRealTraits/lincombs.data.domin.mfunc_d.a_single.rdata")
...
save(lincombs.data.domin.mconti_func_d.a_single, 
     file = 'code/results_analyzing/analysing_ages1_35_top50_equal_interval_bh_partialb_data/allRealTraits/lincombs.data.domin.mconti_func_d.a_single.rdata')
...
load("code/results_analyzing/analysing_ages1_35_top50_equal_interval_bh_partialb_data/allRealTraits/lincombs.data.domin.mconti_func_d.a_single.rdata")
ggthemr::ggthemr(palette = "fresh", layout = "clean")
(domin.mconti_func_d.a_single.logistic=ggplot(data=lincombs.data.domin.mconti_func_d.a_single,
    ...
    annotate(geom="text",
             ...
             y=c(0.9,0.77),
             label=c("italic(β)['MFD'[ab]] == '-0.1264'",
                     "'95% CI' == '[-0.4664, 0.2120]'"),
             parse=T,size=5, hjust = 0)+
    theme_regular_1() 
)
#mconti_func_d.a_all -0.1264    -0.4664      0.212
