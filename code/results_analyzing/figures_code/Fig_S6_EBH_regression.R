...
load("results/fit_results/plot_ages1_35_top50_equal_interval_model_comparison/bh_allb/inter_all_c_alltime.rdata")
inter_all_c_bh_allb = inter_all_c_alltime

inter_all_c = inter_all_c_bh_allb
rm(inter_all_c_bh_allb)
...
str(dat_suc_sp)
save(dat_suc_sp,
     file = 'code/results_analyzing/analysing_ages1_35_top50_equal_interval_bh_allb_data/dat_suc_sp.rdata')
...
save(lincombs.data.estab.mnd.a_single, 
     file = 'code/results_analyzing/analysing_ages1_35_top50_equal_interval_bh_allb_data/lincombs.data.estab.mnd.a_single.rdata')
...
load("code/results_analyzing/analysing_ages1_35_top50_equal_interval_bh_allb_data/lincombs.data.estab.mnd.a_single.rdata")
...
(estab.mnd.a_single.logistic=ggplot(data=lincombs.data.estab.mnd.a_single,aes(x=mnd.a, y=predicted.value))+
    ...
    scale_color_gradient(low = turbo(4)[2],
                         high = turbo(4)[1])+
    scale_x_continuous(limits = c(ifelse(min(dat_suc_sp$mnd.a) > 0,
                                         min(dat_suc_sp$mnd.a) * 0.1,
                                         min(dat_suc_sp$mnd.a) * 1.9  
    ),
    max(dat_suc_sp$mnd.a)), 
    breaks = c(-0.35, 0, 0.35, 0.70))+
    ...
    annotate(geom="text",
             x=min(dat_suc_sp$mnd.a) * 1.9 +
               (max(dat_suc_sp$mnd.a)-min(dat_suc_sp$mnd.a) * 1.9  )*0.01,
             y=c(0.90,0.77),
...
save(lincombs.data.estab.mlgfd.a_single, 
     file = 'code/results_analyzing/analysing_ages1_35_top50_equal_interval_bh_allb_data/lincombs.data.estab.mlgfd.a_single.rdata')
...
load("code/results_analyzing/analysing_ages1_35_top50_equal_interval_bh_allb_data/lincombs.data.estab.mlgfd.a_single.rdata")
ggthemr::ggthemr(palette = "fresh", layout = "clean")
(estab.mlgfd.a_single.logistic=ggplot(data=lincombs.data.estab.mlgfd.a_single,aes(x=mlgfd.a, y=predicted.value))+
    ...
    scale_color_gradient(low = turbo(4)[2],
                         high = turbo(4)[1])+
    scale_x_continuous(limits = c(ifelse(min(dat_suc_sp$mlgfd.a) > 0,
                                         min(dat_suc_sp$mlgfd.a) * 0.5,
                                         min(dat_suc_sp$mlgfd.a) * 1.5  
    ),
    max(dat_suc_sp$mlgfd.a)), 
    breaks = c(-2, -1, 0, 1))+
    ...
    labs(x=' ', y=' ')+
    annotate(geom="text",
             x=min(dat_suc_sp$mlgfd.a) * 1.5 +
               (max(dat_suc_sp$mlgfd.a)-min(dat_suc_sp$mlgfd.a) * 1.5 )*0.01,
             y=c(0.90,0.77),
...
save(lincombs.data.domin.mnd.a_single, 
     file = 'code/results_analyzing/analysing_ages1_35_top50_equal_interval_bh_allb_data/lincombs.data.domin.mnd.a_single.rdata')
...
load("code/results_analyzing/analysing_ages1_35_top50_equal_interval_bh_allb_data/lincombs.data.domin.mnd.a_single.rdata")
ggthemr::ggthemr(palette = "fresh", layout = "clean")
(domin.mnd.a_single.logistic=ggplot(data=lincombs.data.domin.mnd.a_single,aes(x=mnd.a, y=predicted.value))+
    ...
    scale_color_gradient(low = turbo(4)[2],
                         high = turbo(4)[1])+
    scale_x_continuous(limits = c(ifelse(min(dat_dom_sp$mnd.a) > 0,
                                         min(dat_dom_sp$mnd.a) * 0.1,
                                         min(dat_dom_sp$mnd.a) * 2.5  
    ),
    max(dat_dom_sp$mnd.a)), 
    ...
    annotate(geom="text",
             x=min(dat_dom_sp$mnd.a) * 2.5 +
               (max(dat_dom_sp$mnd.a)-min(dat_dom_sp$mnd.a) * 2.5 )*0.32,
             y=c(0.20,0.07),
...
save(lincombs.data.domin.mlgfd.a_single, 
     file = 'code/results_analyzing/analysing_ages1_35_top50_equal_interval_bh_allb_data/lincombs.data.domin.mlgfd.a_single.rdata')
...
load("code/results_analyzing/analysing_ages1_35_top50_equal_interval_bh_allb_data/lincombs.data.domin.mlgfd.a_single.rdata")
ggthemr::ggthemr(palette = "fresh", layout = "clean")
(domin.mlgfd.a_single.logistic=ggplot(data=lincombs.data.domin.mlgfd.a_single,aes(x=mlgfd.a, y=predicted.value))+
    ...
    scale_color_gradient(low = turbo(4)[2],
                         high = turbo(4)[1])+
    scale_x_continuous(limits = c(ifelse(min(dat_dom_sp$mlgfd.a) > 0,
                                         min(dat_dom_sp$mlgfd.a) * 0.5,
                                         min(dat_dom_sp$mlgfd.a) * 1.5  
    ),
    max(dat_dom_sp$mlgfd.a)), 
    breaks = c(-2, -1, 0, 1))+
    ...
    annotate(geom="text",
             x=min(dat_dom_sp$mlgfd.a) * 1.5+
               (max(dat_dom_sp$mlgfd.a)-min(dat_dom_sp$mlgfd.a) * 1.5)*0.01,
             y=c(0.90,0.77),
...
#### Fig.S6：EBH model results for demonstration of how Weighted Mean ND/RFD affects successful colonization and dominance of species, including presentation of raw data and single & multi-regression results ####
library(ggpubr)
library(export)
library(devEMF)
library(cowplot)
...
Fig.S6.all
emf('results/figures/Fig.S6.emf',
