...
load("results/fit_results/plot_ages1_35_top50_equal_interval_model_comparison/bh_partialb_top40/inter_all_c_alltime.rdata")
...
(estab.mlgfd.a_single.logistic=ggplot(data=lincombs.data.estab.mlgfd.a_single,aes(x=mlgfd.a, y=predicted.value))+
    ...
    annotate(geom="text",
             ...
             y=c(0.90,0.77),
             label=c("italic(β)['RFD'[ab]] == '2.92'",
                     "'95% CI' == '[2.50, 3.34]'"),
             parse=T,size=5, hjust = 0)+
    theme_regular_1()
)
#mlgfd.a      2.92       2.50       3.34
...
save(lincombs.data.estab.mpd.a_single, 
     file = 'code/results_analyzing/analysing_ages1_35_top40_equal_interval_bh_partialb_data/lincombs.data.estab.mpd.a_single.rdata')
...
load("code/results_analyzing/analysing_ages1_35_top40_equal_interval_bh_partialb_data/lincombs.data.estab.mpd.a_single.rdata")
ggthemr::ggthemr(palette = "fresh", layout = "clean")
...
# mpd.a_all   -0.0158    -0.0173    -0.0142
...
save(lincombs.data.estab.mconti_func_d.a_single, 
     file = 'code/results_analyzing/analysing_ages1_35_top40_equal_interval_bh_partialb_data/lincombs.data.estab.mconti_func_d.a_single.rdata')
...
load("code/results_analyzing/analysing_ages1_35_top40_equal_interval_bh_partialb_data/lincombs.data.estab.mconti_func_d.a_single.rdata")
ggthemr::ggthemr(palette = "fresh", layout = "clean")
(estab.mconti_func_d.a_single.logistic=ggplot(data=lincombs.data.estab.mconti_func_d.a_single,
    ...
    annotate(geom="text",
             ...
             y=c(0.9,0.77),
             label=c("italic(β)['MFD'[ab]] == '-0.5413'",
                     "'95% CI' == '[-0.6888, -0.3936]'"),
             parse=T,size=5, hjust = 0)+
    theme_regular_1()
)
#mconti_func_d.a_all -0.5413    -0.6888    -0.3936
...
(domin.mnd.a_single.logistic=ggplot(data=lincombs.data.domin.mnd.a_single,aes(x=mnd.a, y=predicted.value))+
    ...
    annotate(geom="text",
             ...
             y=c(0.90,0.77),
             label=c("italic(β)['ND'[ab]] == '2.20'",
                     "'95% CI' == '[0.21, 4.19]'"),
             parse=T,size=5, hjust = 0)+
    theme_regular_1() 
)
#mnd.a        2.20       0.21       4.19
...
(domin.mlgfd.a_single.logistic=ggplot(data=lincombs.data.domin.mlgfd.a_single,aes(x=mlgfd.a, y=predicted.value))+
    ...
    annotate(geom="text",
             ...
             y=c(0.2,0.07),
             label=c("italic(β)['RFD'[ab]] == '1.60'",
                     "'95% CI' == '[0.99, 2.21]'"),
             parse=T,size=5, hjust = 0)+
    theme_regular_1() 
)
#mlgfd.a      1.60       0.99       2.21
...
save(lincombs.data.domin.mpd.a_single, 
     file = 'code/results_analyzing/analysing_ages1_35_top40_equal_interval_bh_partialb_data/lincombs.data.domin.mpd.a_single.rdata')
...
load("code/results_analyzing/analysing_ages1_35_top40_equal_interval_bh_partialb_data/lincombs.data.domin.mpd.a_single.rdata")
ggthemr::ggthemr(palette = "fresh", layout = "clean")
(domin.mpd.a_single.logistic=ggplot(data=lincombs.data.domin.mpd.a_single,aes(x=mpd.a_all, y=predicted.value))+
    ...
    annotate(geom="text",
             ...
             y=c(0.90,0.77),
             label=c("italic(β)['MPD'[ab]] == '-0.0033'",
                     "'95% CI' == '[-0.0063, -0.0003]'"),
             parse=T,size=5, hjust = 0)+
    theme_regular_1() 
)
# mpd.a_all   -0.0033    -0.0063    -0.0003
...
save(lincombs.data.domin.mconti_func_d.a_single, 
     file = 'code/results_analyzing/analysing_ages1_35_top40_equal_interval_bh_partialb_data/lincombs.data.domin.mconti_func_d.a_single.rdata')
...
load("code/results_analyzing/analysing_ages1_35_top40_equal_interval_bh_partialb_data/lincombs.data.domin.mconti_func_d.a_single.rdata")
ggthemr::ggthemr(palette = "fresh", layout = "clean")
(domin.mconti_func_d.a_single.logistic=ggplot(data=lincombs.data.domin.mconti_func_d.a_single,
    ...
    annotate(geom="text",
             ...
             y=c(0.9,0.77),
             label=c("italic(β)['MFD'[ab]] == '-0.0549'",
                     "'95% CI' == '[-0.3978, 0.2872]'"),
             parse=T,size=5, hjust = 0)+
    theme_regular_1() 
)
#mconti_func_d.a_all -0.0549    -0.3978     0.2872
...
#### Fig.S7：BH model results for demonstration of how Weighted Mean ND/RFD affects successful colonization and dominance of species, including presentation of raw data and single & multi-regression results ####
library(ggpubr)
library(export)
library(devEMF)
library(cowplot)
...
Fig.S7.all
emf('results/figures/Fig.S7.emf',
...
#### Fig.S3：BH model results for demonstration of how Weighted Mean PD/FD affects successful colonization and dominance of species, including presentation of raw data and single & multi-regression results ####
library(ggpubr)
library(export)
library(devEMF)
library(cowplot)
...
Fig.S3.all
emf('results/figures/Fig.S3.emf',
    width = 25.2*1.1, height = 16.2*1.1, coordDPI = 1200, 
    emfPlusFontToPath=TRUE, # setting emfPlusFontToPath=TRUE to 
    # ensure text looks correct on the viewing system
    units = 'cm')
