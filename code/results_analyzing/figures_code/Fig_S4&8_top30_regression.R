...
load("results/fit_results/plot_ages1_35_top50_equal_interval_model_comparison/bh_partialb_top30/inter_all_c_alltime.rdata")
inter_all_c_alltime_top30 = inter_all_c_alltime

inter_all_c = inter_all_c_alltime_top30
rm(inter_all_c_alltime_top30)
...
str(dat_suc_sp)
save(dat_suc_sp,
     file = 'code/results_analyzing/analysing_ages1_35_top30_equal_interval_bh_partialb_data/dat_suc_sp.rdata')
...
library(scales)
library(ggthemes)
load('code/results_analyzing/analysing_ages1_35_top30_equal_interval_bh_partialb_data/dat_suc_sp.rdata')
...
save(lincombs.data.estab.mnd.a_single, 
     file = 'code/results_analyzing/analysing_ages1_35_top30_equal_interval_bh_partialb_data/lincombs.data.estab.mnd.a_single.rdata')
...
load("code/results_analyzing/analysing_ages1_35_top30_equal_interval_bh_partialb_data/lincombs.data.estab.mnd.a_single.rdata")
...
save(lincombs.data.estab.mlgfd.a_single, 
     file = 'code/results_analyzing/analysing_ages1_35_top30_equal_interval_bh_partialb_data/lincombs.data.estab.mlgfd.a_single.rdata')
...
load("code/results_analyzing/analysing_ages1_35_top30_equal_interval_bh_partialb_data/lincombs.data.estab.mlgfd.a_single.rdata")
ggthemr::ggthemr(palette = "fresh", layout = "clean")
(estab.mlgfd.a_single.logistic=ggplot(data=lincombs.data.estab.mlgfd.a_single,aes(x=mlgfd.a, y=predicted.value))+
    ...
    labs(x=' ', y=' ')+
    annotate(geom="text",
             x=min(dat_suc_sp$mlgfd.a)+(max(dat_suc_sp$mlgfd.a)-min(dat_suc_sp$mlgfd.a))*0.005,
             y=c(0.90,0.77),
             label=c("italic(β)['RFD'[ab]] == '2.60'",
                     "'95% CI' == '[2.21, 2.99]'"),
             parse=T,size=5, hjust = 0)+
    theme_regular_1()
)
#mlgfd.a      2.60       2.21       2.99
...
save(lincombs.data.estab.mpd.a_single, 
     file = 'code/results_analyzing/analysing_ages1_35_top30_equal_interval_bh_partialb_data/lincombs.data.estab.mpd.a_single.rdata')
...
load("code/results_analyzing/analysing_ages1_35_top30_equal_interval_bh_partialb_data/lincombs.data.estab.mpd.a_single.rdata")
ggthemr::ggthemr(palette = "fresh", layout = "clean")
(estab.mpd.a_single.logistic=ggplot(data=lincombs.data.estab.mpd.a_single,aes(x=mpd.a_all, y=predicted.value))+
    ...
    annotate(geom="text",
             ...
             y=c(0.90,0.77),
             label=c("italic(β)['MPD'[ab]] == '-0.0158'",
                     "'95% CI' == '[-0.0175, -0.0142]'"),
             parse=T,size=5, hjust = 0)+
    theme_regular_1() 
)
# mpd.a_all   -0.0158    -0.0175    -0.0142
...
save(lincombs.data.estab.mconti_func_d.a_single, 
     file = 'code/results_analyzing/analysing_ages1_35_top30_equal_interval_bh_partialb_data/lincombs.data.estab.mconti_func_d.a_single.rdata')
...
load("code/results_analyzing/analysing_ages1_35_top30_equal_interval_bh_partialb_data/lincombs.data.estab.mconti_func_d.a_single.rdata")
ggthemr::ggthemr(palette = "fresh", layout = "clean")
(estab.mconti_func_d.a_single.logistic=ggplot(data=lincombs.data.estab.mconti_func_d.a_single,
    ...
    annotate(geom="text",
             ...
             y=c(0.9,0.77),
             label=c("italic(β)['MFD'[ab]] == '-0.3902'",
                     "'95% CI' == '[-0.5201, -0.2601]'"),
             parse=T,size=5, hjust = 0)+
    theme_regular_1()
)
#mconti_func_d.a_all -0.3902    -0.5201    -0.2601
...
save(lincombs.data.domin.mnd.a_single, 
     file = 'code/results_analyzing/analysing_ages1_35_top30_equal_interval_bh_partialb_data/lincombs.data.domin.mnd.a_single.rdata')
...
load("code/results_analyzing/analysing_ages1_35_top30_equal_interval_bh_partialb_data/lincombs.data.domin.mnd.a_single.rdata")
...
(domin.mnd.a_single.logistic=ggplot(data=lincombs.data.domin.mnd.a_single,aes(x=mnd.a, y=predicted.value))+
    ...
    annotate(geom="text",
             x=min(dat_dom_sp$mnd.a)+(max(dat_dom_sp$mnd.a)-min(dat_dom_sp$mnd.a))*0.05,
             y=c(0.90,0.77),
             label=c("italic(β)['ND'[ab]] == '1.82'",
                     "'95% CI' == '[0.02, 3.62]'"),
             parse=T,size=5, hjust = 0)+
    theme_regular_1() 
)
...
save(lincombs.data.domin.mlgfd.a_single, 
     file = 'code/results_analyzing/analysing_ages1_35_top30_equal_interval_bh_partialb_data/lincombs.data.domin.mlgfd.a_single.rdata')
...
load("code/results_analyzing/analysing_ages1_35_top30_equal_interval_bh_partialb_data/lincombs.data.domin.mlgfd.a_single.rdata")
ggthemr::ggthemr(palette = "fresh", layout = "clean")
(domin.mlgfd.a_single.logistic=ggplot(data=lincombs.data.domin.mlgfd.a_single,aes(x=mlgfd.a, y=predicted.value))+
    ...
    annotate(geom="text",
             x=min(dat_dom_sp$mlgfd.a)+(max(dat_dom_sp$mlgfd.a)-min(dat_dom_sp$mlgfd.a))*0.05,
             y=c(0.2,0.07),
             label=c("italic(β)['RFD'[ab]] == '1.25'",
                     "'95% CI' == '[0.72, 1.77]'"),
             parse=T,size=5, hjust = 0)+
    theme_regular_1() 
)
...
save(lincombs.data.domin.mpd.a_single, 
     file = 'code/results_analyzing/analysing_ages1_35_top30_equal_interval_bh_partialb_data/lincombs.data.domin.mpd.a_single.rdata')
...
load("code/results_analyzing/analysing_ages1_35_top30_equal_interval_bh_partialb_data/lincombs.data.domin.mpd.a_single.rdata")
ggthemr::ggthemr(palette = "fresh", layout = "clean")
(domin.mpd.a_single.logistic=ggplot(data=lincombs.data.domin.mpd.a_single,aes(x=mpd.a_all, y=predicted.value))+
    ...
    annotate(geom="text",
             ...
             y=c(0.90,0.77),
             label=c("italic(β)['MPD'[ab]] == '-0.0026'",
                     "'95% CI' == '[-0.0056, 0.0004]'"),
             parse=T,size=5, hjust = 0)+
    theme_regular_1() 
)
# mpd.a_all   -0.0026    -0.0056     0.0004
...
save(lincombs.data.domin.mconti_func_d.a_single, 
     file = 'code/results_analyzing/analysing_ages1_35_top30_equal_interval_bh_partialb_data/lincombs.data.domin.mconti_func_d.a_single.rdata')
...
load("code/results_analyzing/analysing_ages1_35_top30_equal_interval_bh_partialb_data/lincombs.data.domin.mconti_func_d.a_single.rdata")
ggthemr::ggthemr(palette = "fresh", layout = "clean")
(domin.mconti_func_d.a_single.logistic=ggplot(data=lincombs.data.domin.mconti_func_d.a_single,
    ...
    annotate(geom="text",
             ...
             y=c(0.9,0.77),
             label=c("italic(β)['MFD'[ab]] == '-0.1078'",
                     "'95% CI' == '[-0.4062, 0.1864]'"),
             parse=T,size=5, hjust = 0)+
    theme_regular_1() 
)
#mconti_func_d.a_all -0.1078    -0.4062     0.1864
...
estab_data.inla.md.a_conti_func_d.all_intercept1 = estab_model_md.a_conti_func_d_all$inla.model$summary.fixed%>%
  rownames_to_column()%>%.[-1,]%>%dplyr::rename(lower="0.025quant",median="0.5quant",upper="0.975quant")
...
#### Fig.S8：BH model results for demonstration of how Weighted Mean ND/RFD affects successful colonization and dominance of species, including presentation of raw data and single & multi-regression results ####
library(ggpubr)
library(export)
library(devEMF)
library(cowplot)
...
Fig.S8.all
emf('results/figures/Fig.S8.emf',
...
#### Fig.S4：BH model results for demonstration of how Weighted Mean PD/FD affects successful colonization and dominance of species, including presentation of raw data and single & multi-regression results ####
library(ggpubr)
library(export)
library(devEMF)
library(cowplot)
...
Fig.S4.all
emf('results/figures/Fig.S4.emf',
    width = 25.2*1.1, height = 16.2*1.1, coordDPI = 1200, 
    emfPlusFontToPath=TRUE, # setting emfPlusFontToPath=TRUE to 
    # ensure text looks correct on the viewing system
    units = 'cm')
