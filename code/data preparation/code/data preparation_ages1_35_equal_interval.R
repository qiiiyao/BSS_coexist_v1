...
sp_cover_f1_ages1_35_equal_interval = sp_cover_f1 %>% filter(fake_age %in% seq(1, 35, 2))

sp_cover_f1_ages1_35_equal_interval_fp = split(sp_cover_f1_ages1_35_equal_interval,
                                sp_cover_f1_ages1_35_equal_interval$f_p)
re_cover_ab_f1_ages1_35_equal_interval_fp = lapply(sp_cover_f1_ages1_35_equal_interval_fp, 
                                    function(w){
                                      re_cover_ab = cbind(w[,1:9],
                                                          w[,10:(ncol(w))][colSums(w[,
                                                                                     10:(ncol(w))]) != 0])
                                    })
save(re_cover_ab_f1_ages1_35_equal_interval_fp,
     file = 'code/data preparation/transformed data/re_cover_ab_f1_ages1_35_equal_interval_fp.rdata')
...
freq_sps = apply(sp_cover_f1_ages1_35_equal_interval[,c(10:ncol(sp_cover_f1_ages1_35_equal_interval))], 2, function(x){length(x[x>0])})
...
sp_cover_f1_ages1_35_equal_interval_top50 = cbind(sp_cover_f1_ages1_35_equal_interval[,c(1:9)],
                                   sp_cover_f1_ages1_35_equal_interval %>% select(names(freq_sps_top_50)))
sp_cover_f1_ages1_35_equal_interval_top50_fp = split(sp_cover_f1_ages1_35_equal_interval_top50, sp_cover_f1_ages1_35_equal_interval_top50$f_p)
...
sp_cover_ages1_35_equal_interval_top25_exotic = cbind(sp_cover_f1_ages1_35_equal_interval[,c(1:9)],
                                       sp_cover_f1_ages1_35_equal_interval %>% select(names(freq_sps_top_25exotic_allnative)))
sp_cover_ages1_35_equal_interval_top25_exotic_fp = split(sp_cover_ages1_35_equal_interval_top25_exotic,
                                                         sp_cover_ages1_35_equal_interval_top25_exotic$f_p)
save(sp_cover_ages1_35_equal_interval_top25_exotic_fp,
     file = 'code/data preparation/transformed data/sp_cover_ages1_35_equal_interval_top25_exotic_fp.rdata')
...
sp_cover_f1_ages1_35_equal_interval_top40 = cbind(sp_cover_f1_ages1_35_equal_interval[,c(1:9)],
                                   sp_cover_f1_ages1_35_equal_interval %>% select(names(freq_sps_top_40)))
sp_cover_f1_ages1_35_equal_interval_top40_fp = split(sp_cover_f1_ages1_35_equal_interval_top40, sp_cover_f1_ages1_35_equal_interval_top40$f_p)
...
sp_cover_ages1_35_equal_interval_top20_exotic = cbind(sp_cover_f1_ages1_35_equal_interval[,c(1:9)],
                                       sp_cover_f1_ages1_35_equal_interval %>% select(names(freq_sps_top_20exotic_allnative)))
sp_cover_ages1_35_equal_interval_top20_exotic_fp = split(sp_cover_ages1_35_equal_interval_top20_exotic,
                                                         sp_cover_ages1_35_equal_interval_top20_exotic$f_p)
save(sp_cover_ages1_35_equal_interval_top20_exotic_fp,
     file = 'code/data preparation/transformed data/sp_cover_ages1_35_equal_interval_top20_exotic_fp.rdata')
...
sp_cover_f1_ages1_35_equal_interval_top30 = cbind(sp_cover_f1_ages1_35_equal_interval[,c(1:9)],
                                   sp_cover_f1_ages1_35_equal_interval %>% select(names(freq_sps_top_30)))
sp_cover_f1_ages1_35_equal_interval_top30_fp = split(sp_cover_f1_ages1_35_equal_interval_top30, sp_cover_f1_ages1_35_equal_interval_top30$f_p)
...
sp_cover_ages1_35_equal_interval_top15_exotic = cbind(sp_cover_f1_ages1_35_equal_interval[,c(1:9)],
                                       sp_cover_f1_ages1_35_equal_interval %>% select(names(freq_sps_top_15exotic_allnative)))
sp_cover_ages1_35_equal_interval_top15_exotic_fp = split(sp_cover_ages1_35_equal_interval_top15_exotic,
                                                         sp_cover_ages1_35_equal_interval_top15_exotic$f_p)
save(sp_cover_ages1_35_equal_interval_top15_exotic_fp,
     file = 'code/data preparation/transformed data/sp_cover_ages1_35_equal_interval_top15_exotic_fp.rdata')
...
abundance_raw = sapply(re_cover_ab_f1_ages1_35_equal_interval_fp,
                       function(x){sum(x[,c(10:ncol(x))])})
richness_raw = sapply(re_cover_ab_f1_ages1_35_equal_interval_fp,
                      function(x){ncol(x[,c(10:ncol(x))])})

fit_fp_top50_ages1_35_equal_interval = lapply(sp_cover_f1_ages1_35_equal_interval_top50_fp, fit_prepa_top)
fit_fp_top50_ages1_35_equal_interval_prop = lapply(sp_cover_f1_ages1_35_equal_interval_top50_fp, fit_prepa_top_prop)
intro_sp_top50_early_suc = sapply(fit_fp_top50_ages1_35_equal_interval,
...
domin_sp_top50_early_suc = sapply(fit_fp_top50_ages1_35_equal_interval,
                                  function(x){length(strsplit(x[["stage_sp_name"]][4], ', ')[[1]])})
length(intro_sp_top50_early_suc[which(intro_sp_top50_early_suc == 0)])/length(intro_sp_top50_early_suc)
mean(sapply(fit_fp_top50_ages1_35_equal_interval,
            function(x){ncol(x[["re_cover_ab"]])-9})) ## mean 36 species
abundance_pro = mean(sapply(fit_fp_top50_ages1_35_equal_interval,
                            function(x){sum(x[["re_cover_ab"]][,c(10:ncol(x[["re_cover_ab"]]))])})/abundance_raw)
# 0.8902485
richness_pro = mean(sapply(fit_fp_top50_ages1_35_equal_interval,
                           function(x){ncol(x[["re_cover_ab"]][,c(10:ncol(x[["re_cover_ab"]]))])})/richness_raw)
# 0.6707662
mean(sapply(fit_fp_top50_ages1_35_equal_interval,
            function(x){nrow(x[["re_cover_ab"]])})) 
# 17.96667
save(fit_fp_top50_ages1_35_equal_interval,
     file = "code/data preparation/transformed data/fit_fp_top50_ages1_35_equal_interval.RData")
...
fit_fp_top40_ages1_35_equal_interval = lapply(sp_cover_f1_ages1_35_equal_interval_top40_fp, fit_prepa_top)
abundance_pro = mean(sapply(fit_fp_top40_ages1_35_equal_interval,
                            function(x){sum(x[["re_cover_ab"]][,c(10:ncol(x[["re_cover_ab"]]))])})/abundance_raw)
# 0.8284944
richness_pro = mean(sapply(fit_fp_top40_ages1_35_equal_interval,
                           function(x){ncol(x[["re_cover_ab"]][,c(10:ncol(x[["re_cover_ab"]]))])})/richness_raw)
# 0.5758943
mean(sapply(fit_fp_top40_ages1_35_equal_interval,
            function(x){nrow(x[["re_cover_ab"]])})) 
# 17.96667

save(fit_fp_top40_ages1_35_equal_interval,
     file = "code/data preparation/transformed data/fit_fp_top40_ages1_35_equal_interval.RData")


## top 30 sps for early succession (ages 1-35)
fit_fp_top30_ages1_35_equal_interval = lapply(sp_cover_f1_ages1_35_equal_interval_top30_fp, fit_prepa_top)
abundance_pro = mean(sapply(fit_fp_top30_ages1_35_equal_interval,
                            function(x){sum(x[["re_cover_ab"]][,c(10:ncol(x[["re_cover_ab"]]))])})/abundance_raw)
# 0.7491658
richness_pro = mean(sapply(fit_fp_top30_ages1_35_equal_interval,
                           function(x){ncol(x[["re_cover_ab"]][,c(10:ncol(x[["re_cover_ab"]]))])})/richness_raw)
# 0.4602996
mean(sapply(fit_fp_top30_ages1_35_equal_interval,
            function(x){nrow(x[["re_cover_ab"]])})) 
# 17.96667
save(fit_fp_top30_ages1_35_equal_interval,
     file = "code/data preparation/transformed data/fit_fp_top30_ages1_35_equal_interval.RData")
