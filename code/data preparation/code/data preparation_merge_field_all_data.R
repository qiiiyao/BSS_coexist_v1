...
sp_cover_f2_top50_ages1_35 = sp_cover_f2_top50 %>% 
...
fit_fp_ages1_35_top50_mergeall = fit_prepa_top_merge(sp_cover_f2_top50_ages1_35_merge_all,
                                                     posi_sp_start = 2)

save(fit_fp_ages1_35_top50_mergeall, 
     file = "code/data preparation/transformed data/fit_fp_ages1_35_top50_mergeall.RData")
